package com.hurlant.crypto.prng
{
   ...
   public class Random
   {
      ...
      public function Random(param1:Class = null)
      {
         ...
         var_124 = new ByteArray();
         var_51 = 0;
         while(var_51 < psize)
         {
            _loc2_ = uint(65536 * Math.random());
            var _loc3_:* = var_51++;
            var_124[_loc3_] = _loc2_ >>> 8;
            var _loc4_:*;
            var_124[_loc4_ = var_51++] = _loc2_ & 255;
         }
         var_51 = 0;
         seed();
      }
      ...
      public function seed(param1:int = 0) : void
      {
         ...
         var _loc2_:* = var_51++;
         var_124[_loc2_] = 0 ^ param1 & 255;
         var _loc3_:* = var_51++;
         var_124[_loc3_] = 0 ^ param1 >> 8 & 255;
         var _loc4_:*;
         var_124[_loc4_ = var_51++] = 0 ^ param1 >> 16 & 255;
         var _loc5_:*;
         var_124[_loc5_ = var_51++] = 0 ^ param1 >> 24 & 255;
         var_51 %= psize;
         var_1802 = true;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            var_124[_loc1_] = Math.random() * 256;
            _loc1_++;
         }
         var_124.length = 0;
         var_124 = null;

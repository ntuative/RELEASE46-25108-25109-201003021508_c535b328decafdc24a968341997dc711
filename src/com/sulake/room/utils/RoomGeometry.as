package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_703:Number = 64;
      
      public static const const_1012:Number = 32;
      ...
      private var var_1441:Number = 1;
      
      private var var_76:int = 0;
      
      private var var_380:Map = null;
      
      private var var_967:Vector3d;
      ...
      private var var_1440:Number = 1;
      
      private var var_2336:Number = 500;
      ...
      private var var_2335:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_86 = new Vector3d();
         var_967 = new Vector3d();
         var_1441 = 1;
         var_1439 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1440 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:* = 0;
         var_218.assign(param1);
         if(var_218.x != _loc2_ || var_218.y != _loc3_ || var_218.z != _loc4_)
         {
            ++var_76;
         }
      ...
      {
         if(var_378 != param1 * var_1440)
         {
            var_378 = param1 * var_1440;
            ++var_76;
         }
      }
      ...
      {
         if(var_377 != param1 * var_1441)
         {
            var_377 = param1 * var_1441;
            ++var_76;
         }
      }
      ...
      {
         if(var_379 != param1 * var_1439)
         {
            var_379 = param1 * var_1439;
            ++var_76;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_380 != null)
         {
            ...
            var_380.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_380.add(_loc3_,_loc4_);
            ++var_76;
         }
      }
      ...
      {
         return new Vector3d(var_218.x,var_218.y,var_218.z);
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_967.assign(_loc22_);
         }
         else
         {
            var_967.assign(_loc17_);
         }
         ++var_76;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_379;
         _loc2_.z *= var_378;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_967);
         if(_loc3_ < var_2335 || _loc3_ > var_2336)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_379;
            _loc2_.z *= var_378;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_967);
         }
      ...
      {
         return new Vector3d(0 * var_377,0 * var_379,0 * var_378);
      }
      ...
      {
         return scale == const_703;
      }
      
      public function get scale() : Number
      {
         return var_185 / Math.sqrt(0.5);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_380 != null)
         {
            ...
            return var_380.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc5_:Number = param1.x / var_185;
         var _loc6_:Number = -param1.y / var_185;
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_85,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_377,0 * var_379,0 * var_378);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_86;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_377,param2.y * var_379,param2.z * var_378);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_377,param3.y * var_379,param3.z * var_378);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_377,param4.y * var_379,param4.z * var_378);

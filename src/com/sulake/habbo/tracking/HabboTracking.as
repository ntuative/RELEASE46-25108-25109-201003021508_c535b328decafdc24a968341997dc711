package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_769:uint = 11;
      ...
      private var var_397:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_1017:int = -1;
      
      private var var_1238:LagWarningLogger = null;
      
      private var var_842:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1238 = new LagWarningLogger();
         var_1237 = new Array(const_769);
         var _loc4_:int = 0;
         while(_loc4_ < const_769)
         {
            var_1237[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1348,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1358,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_514,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_878,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1246);
               break;
            case HabboCommunicationEvent.const_522:
               trackLoginStep(HabboLoginTrackingStep.const_1347,String(_communication.port));
               break;
            case HabboCommunicationEvent.const_220:
               trackLoginStep(HabboLoginTrackingStep.const_220);
               break;
            case HabboCommunicationEvent.const_151:
               trackLoginStep(HabboLoginTrackingStep.const_151);
               break;
            case HabboCommunicationEvent.const_156:
      ...
      {
         var_58 = param2 as IRoomWidgetFactory;
         Component(var_58).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_CLOSE,onWidgetTrackingEvent);
         Component(var_58).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DEFAULT,onWidgetTrackingEvent);
         Component(var_58).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DANCE,onWidgetTrackingEvent);
         Component(var_58).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_EFFECTS,onWidgetTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_304:
      ...
      private function include(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_175)
         {
            Component(var_175).events.addEventListener(HabboConfigurationEvent.const_163,onConfigurationLoaded);
            if(var_230 != null)
            {
               var_230.configuration = var_175;
            }
            if(var_231 != null)
            {
               var_231.configuration = var_175;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _adManager.events.addEventListener(AdEvent.const_474,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_878,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_514,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_522,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_220,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_156,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_151,onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_186,onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_626,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_58,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_420,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_461:
               var_1238.registerWarning(LagWarningLogger.const_808);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_842)
            {
               var_842.release(new IIDHabboWindowManager());
               var_842 = null;
            }
            if(_adManager)
            {
            ...
            if(var_58)
            {
               var_58.release(new IIDHabboRoomWidget());
               var_58 = null;
            }
            if(_navigator)
            {
            ...
            if(var_176)
            {
               if(true)
               {
                  ...
                  Component(var_176).events.removeEventListener(HabboFriendListTrackingEvent.const_304,onFriendlistTrackingEvent);
               }
            ...
            if(var_397)
            {
               if(true)
               {
                  var_397.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_397.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_397.release(new IIDHabboHelp());
               var_397 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_461,onLagWarningEvent);
               }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_175)
         {
            Component(var_175).events.removeEventListener(HabboConfigurationEvent.const_163,onConfigurationLoaded);
         }
      }
      ...
      private function onLocalizationLoaded(param1:Event) : void
      {
         ...
         trackLoginStep(HabboLoginTrackingStep.const_87);
         if(_localization)
         {
            Component(_localization).events.removeEventListener(LocalizationEvent.const_87,onLocalizationLoaded);
         }
      }
      
      private function onHelpReady(param1:IID, param2:IUnknown) : void
      {
         var_397 = param2 as IHabboHelp;
         var_397.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_397.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_1015);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_1015,onCoreRunning);
         }
      }
      ...
      {
         var_842 = IHabboWindowManager(param2);
         if(var_842)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++var_1513;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1513);
         }
         if(var_1017 > -1 && _loc2_ - var_1017 > 15000)
         {
            ++var_1514;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1514);
         }
         var_1017 = _loc2_;
         if(var_231 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_461,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_255,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_176).events.addEventListener(HabboFriendListTrackingEvent.const_304,onFriendlistTrackingEvent);
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.addEventListener(LocalizationEvent.const_87,onLocalizationLoaded);
         }
      }
      
      private function onHotelViewEvent(param1:Event) : void
      {
         if(param1.type == HabboHotelViewEvent.const_626)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1374);
         }
         else if(param1.type == HabboHotelViewEvent.const_420)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1291);
         }

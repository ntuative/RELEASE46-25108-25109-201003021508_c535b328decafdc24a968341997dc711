package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_363:IScrollbarWindow;
      
      private var var_794:UserCountRenderer;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         var_794 = new UserCountRenderer(_navigator);
      }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         if(var_1192 != null)
         {
            _loc2_ = var_1192.tags[0];
            var_1192.color = getBgColor(_loc2_);
         }
         var_1192 = param1;
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         var_363 = IScrollbarWindow(var_20.findChildByName("scroller"));
      }
      
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         var _loc2_:WindowMouseEvent = WindowMouseEvent(param1);
         var _loc3_:int = Math.abs(var_1839 - _loc2_.stageX);
         var_1839 = _loc2_.stageX;
         var_1840 = _loc3_ > 2;
      }
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         _navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_172,null,0);
         _navigator.refreshButton(param1,"doormode_password_small",param2.doorMode == RoomSettingsFlatInfo.const_121,null,0);
         refreshRoomName(param1,param2);
         var_794.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_227)
         {
            ...
            if(_loc7_.ownerName != _navigator.sessionData.userName)
            {
               ...
               switch(_loc7_.doorMode)
               {
                  case RoomSettingsFlatInfo.const_121:
                     ...
                     return;
                  case RoomSettingsFlatInfo.const_172:
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1335,true);

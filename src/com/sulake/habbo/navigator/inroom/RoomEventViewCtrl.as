package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = var_733.getText();
         var _loc6_:Array = new Array();
         addTag(_loc6_,var_904.getText());
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         var_2214.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_733.setText(param1.eventDescription);
         var_904.setText(getTagFromEvent(param1,1));
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1576 = IWindowContainer(find("event_type_disabled_cont"));
            var_2214 = ITextWindow(find("event_type_disabled_text"));
            var_1575 = ITextWindow(find("create_caption"));
            var_1574 = ITextWindow(find("edit_caption"));
            var_1332 = IButtonWindow(find("create_button"));
            var_1331 = IButtonWindow(find("edit_button"));
            var_2215 = IButtonWindow(find("cancel_button"));
            var_1333 = IButtonWindow(find("end_button"));
            var_905 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1332,onCreateButtonClick);
            Util.setProcDirectly(var_1331,onEditButtonClick);
            Util.setProcDirectly(var_1333,onEndButtonClick);
            Util.setProcDirectly(var_2215,onCancelButtonClick);
            _eventNameInput = new TextFieldManager(_navigator,getInput("event_name"),25);
            var_733 = new TextFieldManager(_navigator,getInput("event_desc"),100);
            var_904 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!var_733.checkMandatory(_navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;

package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private var var_2371:BitmapData;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         var_47 = param3;
         var_1290 = param4;
         var_1563 = var_582.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            if(_loc5_ == null || var_1563 == null)
            {
               return;
            }
            _loc2_ = var_1563.clone() as IWindowContainer;
            if(_loc2_ == null)
            {
               return;
            }
            ...
            if(_loc7_ != null)
            {
               ...
               _loc9_ = var_582.assets.getAssetByName(_loc8_) as BitmapDataAsset;

package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_990:UserInfoCtrl;
      
      private var var_111:IssueBundle;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.releaseBundle(var_111.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = var_111.getHighestPriorityIssue();
         var_386 = new UserInfoCtrl(_window,var_56,_loc3_.message);
         var_990 = new UserInfoCtrl(_window,var_56,_loc3_.message);
         var_386.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_111.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_990.load(_loc4_,var_111.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.closeBundle(var_111.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc4_:Array = var_111.issues;
         var _loc5_:int = 0;
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = var_111.getHighestPriorityIssue().issueId;
         var_56.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_56,WindowTracker.const_789,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_56 != null && false && var_111 != null)
         {
            var_56.issueManager.removeHandler(var_111.id);
         }
         this.dispose();
      }
      ...
      private function onResized(param1:WindowEvent) : void
      {
         ...
         var _loc5_:int = (_loc2_.height - _loc2_.method_1.height + _loc3_.height + _loc4_.height) * 0.5;
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = var_111.getHighestPriorityIssue();
            var_386 = new UserInfoCtrl(_window,var_56,_loc3_.message);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.closeBundle(var_111.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.closeBundle(var_111.id,3);
         checkAutoHandling();
         dispose();
      }
      ...
      {
         return WindowTracker.const_1257;
      }
   }
}

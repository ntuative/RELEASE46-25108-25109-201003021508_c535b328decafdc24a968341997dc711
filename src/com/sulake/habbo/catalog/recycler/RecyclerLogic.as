package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_759:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1477)
         {
            case RecyclerStatusMessageEvent.const_1211:
               var_257 = const_339;
               if(_view == null)
               {
                  return;
            ...
            case RecyclerStatusMessageEvent.const_979:
               ...
               break;
            case RecyclerStatusMessageEvent.const_1243:
               if(_view == null)
               {
                  return;
               }
      ...
      public function executeRecycler() : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < var_98.length)
         {
            _loc3_ = var_98[_loc2_];
            if(_loc3_ == null)
            {
               return;
            }
      ...
      {
         return var_1477 != RecyclerStatusMessageEvent.const_979;
      }
      
      private function get statusActive() : Boolean
      {
         return var_257 != const_759;
      }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(var_98.length < const_154)
         {
            return false;
         }
         var _loc1_:int = 0;
         while(_loc1_ < var_98.length)
         {
            if(true)
            {
               return false;
      ...
      {
         return active && var_257 == const_339;
      }
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(false)
         {
            oldObjectData = var_98[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_154)
            {
               oldObjectData = var_98[newSlotId];
         ...
         var_98[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         updateRecyclerSlots();
         updateRecyclerButton();
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_844:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1230:
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(!_catalog.returnInventoryFurniFromRecycler(var_98[param1].id))
         {
            return;
         }
         var_98[param1] = null;

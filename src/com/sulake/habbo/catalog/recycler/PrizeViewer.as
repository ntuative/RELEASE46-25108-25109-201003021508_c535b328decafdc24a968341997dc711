package com.sulake.habbo.catalog.recycler
{
   ...
   public class PrizeViewer implements IGetImageListener
   {
      ...
      private var var_254:IBitmapWrapperWindow;
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         var_254.bitmap = new BitmapData(var_254.width,var_254.height,true,16777215);
         var_254.bitmap.fillRect(var_254.bitmap.rect,16777215);
         var _loc2_:Point = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
         var_254.bitmap.copyPixels(param1,param1.rect,_loc2_,null,null,true);
      }
      ...
      {
         var _loc8_:* = null;
         var_254 = param2.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         switch(param3)
         {

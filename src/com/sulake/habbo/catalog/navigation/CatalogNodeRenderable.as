package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1062:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1488:XML;
      
      private static var var_1487:XML;
       
      
      private var var_2296:IWindowContainer;
      ...
      private var var_1486:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1486 == 4294967295)
            {
               var_1486 = _loc1_.color;
            }
            _loc1_.color = const_1062;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1366;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1488) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_47 = navigator.catalog.windowManager.buildFromXML(var_1487) as IItemListWindow;
         if(var_47 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1158;
            }
         }
      }

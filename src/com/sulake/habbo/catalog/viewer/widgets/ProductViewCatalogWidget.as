package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1262:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_588 != null)
         {
            var_588.visible = false;
            var_588.destroyGridItems();
         }
         if(var_1262 != null)
         {
            var_1262.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1304.text = "${" + _loc3_.name + "}";
            var_1303.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1304.text = "${" + _loc2_.localizationId + "}";
            var_1303.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_357:
                  _loc4_ = var_1261.clone();
                  if(var_588 != null)
                  {
                     var_588.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_588,var_1262,var_1372);
                  }
                  break;
               ...
               case Offer.const_468:
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_193:
                        ...
                        _loc4_ = new BitmapData(var_84.width,var_84.height,false,_loc10_);
                        _loc11_ = null;
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              _loc13_.setDirection(AvatarSetType.const_45,3);
                              _loc13_.initActionAppends();
                              _loc13_.appendAction(AvatarAction.const_332,AvatarAction.const_567);
      ...
      {
         var_1304 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1303 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_84 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1522 = new Point(var_84.x,var_84.y);
         var_588 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1262 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_588 == null)
         {
         ...
         var_1261 = _loc2_.content as BitmapData;
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(var_84);
      ...
      private function setPreviewImage(param1:BitmapData, param2:Point = null) : void
      {
         ...
         if(true)
         {
            var_84.bitmap = new BitmapData(var_84.width,var_84.height,true,16777215);
         }
         var_84.bitmap.fillRect(var_84.bitmap.rect,16777215);
         var _loc3_:Point = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
         var_84.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         var_84.invalidate();
         var_84.x = var_1522.x;
         var_84.y = var_1522.y;
         if(param2 != null)

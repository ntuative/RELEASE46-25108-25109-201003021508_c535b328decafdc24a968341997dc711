package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_989 != null)
         {
            var_989.removeEventListener(WindowKeyboardEvent.const_142,windowKeyEventProcessor);
         }
      }
      ...
      override public function init() : void
      {
         ...
         var_989 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_989 != null)
         {
            var_989.addEventListener(WindowKeyboardEvent.const_142,windowKeyEventProcessor);
         }
      }

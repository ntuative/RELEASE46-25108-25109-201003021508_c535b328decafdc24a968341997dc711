package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:Map = var_426.getWithIndex(var_202);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(var_518);
            if(_loc3_ == null)
            {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         var_84.bitmap.copyPixels(param1,param1.rect,_loc2_,null,null,true);
         var_84.invalidate();
      }
      ...
      override public function init() : void
      {
         ...
         var _loc8_:* = null;
         super.init();
         var_84 = window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(var_426.getValue(_loc6_) == null)
            {
               var_426.add(_loc6_,new Map());
            }
            _loc8_ = var_426.getValue(_loc6_) as Map;
            _loc8_.add(_loc7_,_loc3_);
         }
         _loc4_ = var_426.getWithIndex(var_202);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(var_518);
            if(_loc3_ == null)
            {

package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IRecyclerVisualization
   {
      ...
      private var var_248:CatalogObjectMover;
      ...
      private function renderSlotGraphics() : void
      {
         ...
         _loc2_ = 1;
         while(_loc2_ <= RecyclerLogic.const_154)
         {
      ...
      public function updateSlots() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < RecyclerLogic.const_154)
         {
      ...
      private function onMainContainerEvent(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_27:
               if(var_248 != null)
               {
                  var_248.onMainContainerEvent(param1,param2,_loc4_);
               }
               break;
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               if(var_248 == null)
               {
                  var_248 = new CatalogObjectMover();
                  var_248.mainContainer = window;
                  var_248.roomEngine = _loc3_;
               }
               var_248.onMainContainerEvent(param1,param2,_loc4_);
         }
      }

package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1372:XML;
      
      private var _itemList:IItemListWindow;
      
      private var var_857:PrizeViewer;
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_710.length)
         {
            createLevelItem(var_710[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_857 = new PrizeViewer();
         var_548 = new Map();
         var_710 = recycler.getPrizeTable();
         if(var_710 == null)
         {
            return;
         }
         ...
         var_2060 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_710[0].prizes.length > 0)
         {
            select(var_710[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_2060) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1372) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_857.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }

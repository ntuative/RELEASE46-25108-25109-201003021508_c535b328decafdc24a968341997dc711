package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         var_1157 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1157) as IWindowContainer;
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_648.width,var_648.height,true,0);
               _loc3_.bitmap.copyPixels(var_648,var_648.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_771.width,var_771.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_650.width,var_650.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_650,var_650.rect,new Point(0,0),null,null,true);

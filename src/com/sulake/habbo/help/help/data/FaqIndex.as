package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_683:FaqCategory;
      
      private var var_684:FaqCategory;
      ...
      {
         super();
         var_684 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_683 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_129 = new Map();
      }
      ...
      {
         var _loc4_:* = null;
         if(var_684.hasItem(param1))
         {
            var_684.getItem(param1).answerText = param2;
         }
         if(_frontPageNormal.hasItem(param1))
         {
            _frontPageNormal.getItem(param1).answerText = param2;
         }
         if(var_683.hasItem(param1))
         {
            var_683.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;

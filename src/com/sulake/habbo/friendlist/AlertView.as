package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_friendList.getXmlWindow(this.var_1110));
      ...
      public function show() : void
      {
         ...
         var _loc2_:Rectangle = Util.getLocationRelativeTo(_friendList.view.mainWindow,var_243.width,var_243.height);
         var_243.x = _loc2_.x;
         var_243.y = _loc2_.y;

package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1396:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_318 && _loc4_.state != FriendRequest.const_310)
            {
               _loc3_.addAcceptedRequest(_loc4_.requestId);
               _loc4_.state = FriendRequest.const_318;
      ...
      {
         var_1394 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1395 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1395.procedure = onDismissAllButtonClick;
         var_1394.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in _friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_318 && _loc4_.state != FriendRequest.const_310)
            {
               ...
               if(_friendList && false)
               {
                  _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_257,_loc4_.requestId));
               }
            }
         }
         refresh();
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         param1.view.color = _friendList.laf.getRowShadingColor(FriendListTab.const_83,param2);
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         _friendList.refreshText(_loc2_,"requester_name_text",true,param1.method_5);
         if(param1.state == FriendRequest.const_130)
         {
         ...
         else if(param1.state == FriendRequest.const_318)
         {
         ...
         else if(param1.state == FriendRequest.const_940)
         {
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_318;
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         if(_friendList && false)
         {
            _friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_257,param1));
         }
      }
   }
}

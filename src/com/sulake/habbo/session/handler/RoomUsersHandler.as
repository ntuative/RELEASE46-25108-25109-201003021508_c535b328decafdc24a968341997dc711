package com.sulake.habbo.session.handler
{
   ...
   public class RoomUsersHandler extends BaseHandler
   {
      ...
      private function onDoorbell(param1:IMessageEvent) : void
      {
         ...
         listener.events.dispatchEvent(new RoomSessionDoorbellEvent(RoomSessionDoorbellEvent.const_98,_loc3_,_loc2_.userName));
      }
      ...
      private function onFriendRequest(param1:NewBuddyRequestEvent) : void
      {
         ...
         listener.events.dispatchEvent(new RoomSessionFriendRequestEvent(_loc3_,_loc4_.requestId,_loc4_.requestId,_loc4_.method_5));
      }

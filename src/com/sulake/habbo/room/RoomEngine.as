package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_487:String = "room";
      
      private static const const_756:int = -2;
      
      private static const const_486:String = "temporary_room";
      
      private static const const_275:String = "object_icon_sprite";
      
      private static const const_757:int = -3;
      
      private static const const_755:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1060:String = "tile_cursor";
      ...
      private var var_564:NumberBank;
      ...
      private var var_672:RoomMessageHandler = null;
      
      private var var_673:IRoomRendererFactory = null;
      
      private var var_1846:Boolean = false;
      
      private var var_110:int = 0;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_294 = new Map();
         var_564 = new NumberBank(1000);
         var_986 = new Map();
         var_293 = new Map();
         var_66 = new RoomObjectEventHandler(this);
         var_672 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_66 != null)
         {
            ...
            {
               return var_66.deleteWallItem(var_109,var_110,param1);
            }
         }
         return false;
      }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc49_:* = null;
         var _loc2_:int = 0;
         for(; _loc2_ < var_294.length; _loc2_++)
         {
            _loc3_ = var_294.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_705) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_628) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_551) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_507) + 0.5;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_139);
            if(_loc7_ != null)
            {
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_66 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_28)
            {
               return var_66.modifyWallItemData(var_109,var_110,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_416 != null)
         {
            var_416.release(new IIDRoomObjectVisualizationFactory());
            var_416 = null;
         }
         if(var_41 != null)
         {
         ...
         if(var_673 != null)
         {
            var_673.release(new IIDRoomRendererFactory());
            var_673 = null;
         }
         ...
         if(var_294 != null)
         {
            ...
            {
               _loc2_ = var_294.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_673.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_876;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_516);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_693);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_517);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_936);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_929);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_946) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_848);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_404,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_658,var_109,var_110,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_66 != null)
         {
            return var_66.modifyRoomObject(var_109,var_110,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_293.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_293.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_593,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_602,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_583,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_41 != null)
         {
            var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_29);
            var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_28);
            var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_33);
            var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_273);
            var_41.addObjectUpdateCategory(RoomObjectCategoryEnum.const_60);
            var_41.setContentLoader(var_9);
         }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_66 != null)
         {
            var_66.handleRoomObjectEvent(param1,var_109,var_110);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_315,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_331,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_849,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_852,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_838,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_248,param1,param2,param3,RoomObjectCategoryEnum.const_29));
         }
         return true;
      }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_726,param1,param2));
      }
      
      private function initializeRoomManager() : void
      {
         if(var_25 == null || var_416 == null || var_41 == null || var_673 == null || _communication == null || var_97 == null || !var_1846)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_276,RoomObjectCategoryEnum.const_60);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1369,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_41.getRoom(getRoomIdentifier(var_109,var_110));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_757,RoomObjectCategoryEnum.const_273);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_109,var_110,var_1195);
         if(_loc2_ != null)
         {
            _loc3_ = getOverlaySprite(_loc2_);
            _loc4_ = getOverlayIconSprite(_loc3_,const_275);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_109,var_110,var_1195);
         if(_loc1_ != null)
         {
            _loc2_ = getOverlaySprite(_loc1_);
            removeOverlayIconSprite(_loc2_,const_275);
         }
      }
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_9 != null)
         {
            var_9.visualizationFactory = var_416;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_25 != null)
         {
            if(false)
            {
               var_25.events.addEventListener(RoomObjectMouseEvent.const_197,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMouseEvent.const_378,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMouseEvent.const_388,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectStateChangeEvent.const_264,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectStateChangeEvent.const_531,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_111,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_125,roomObjectEventHandler);
               ...
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_128,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_108,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_122,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectWidgetRequestEvent.const_91,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_453,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_422,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_407,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_356,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_456,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_SOUND_MACHINE_START,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_435,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_438,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_436,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectFurnitureActionEvent.const_383,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectDimmerStateUpdateEvent.DIMMER_STATE,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMoveEvent.const_393,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectMoveEvent.const_372,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_255,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_475,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_319,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomAdEvent.const_322,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomActionEvent.const_466,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomActionEvent.const_862,roomObjectEventHandler);
               var_25.events.addEventListener(RoomObjectRoomActionEvent.const_368,roomObjectEventHandler);
               var_25.events.addEventListener(AvatarWalkWarpingWarningEvent.const_461,warningEventHandler);
            }
         }
      }
      ...
      {
         var _loc5_:IRoomInstance = getRoom(var_109,var_110);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_730) != 0)
         {
            return false;
         }
         if(var_66 != null)
         {
            return var_66.initializeRoomObjectInsert(var_109,var_110,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         if(param1)
         {
            ...
            {
               _loc3_ = var_293.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_248,param1,param2,param3,RoomObjectCategoryEnum.const_33));
         }
         return true;
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_28:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_417);
                     break;
                  case RoomObjectCategoryEnum.const_33:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_167);
               }
            }
         }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_292);
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_622)
         {
            var_1846 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_315,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_331,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_876,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_248,param1,param2,param3,RoomObjectCategoryEnum.const_28));
         }
         return true;
      }
      ...
      private function createObject(param1:String, param2:int, param3:String, param4:int) : IRoomObjectController
      {
         ...
         var _loc6_:* = null;
         return _loc5_.method_2(param2,param3,param4) as IRoomObjectController;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         _adManager.events.addEventListener(AdEvent.const_474,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_755) as Sprite;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = var_294.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_673 = param2 as IRoomRendererFactory;
         initializeRoomManager();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_465 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_41.getRoom(const_486);
         if(_loc10_ == null)
         {
            _loc10_ = var_41.createRoom(const_486,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_564.reserveNumber();
         ...
         _loc11_ += 1;
         var _loc13_:IRoomObjectController = _loc10_.method_2(_loc11_,param1,_loc12_) as IRoomObjectController;
         ...
         switch(_loc12_)
         {
            ...
            case RoomObjectCategoryEnum.const_28:
               ...
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_417,param8);
               break;
            case RoomObjectCategoryEnum.const_33:
               _loc13_.getModelController().setString(RoomObjectVariableEnum.const_167,param2);
               break;
            case RoomObjectCategoryEnum.const_60:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_236,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc22_ = _loc21_.getXML();
                     _loc13_.getEventHandler().initialize(_loc22_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_625,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_698,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_539,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_404,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_986.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_788,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_564.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_756,RoomObjectCategoryEnum.const_273);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = getRoomCanvas(var_109,var_110,param1);
         if(_loc9_ != null)
         {
            var_1195 = param1;
            var_1462 = param2;
            ...
            _loc11_ = getOverlayIconSprite(_loc10_,const_275);
            if(_loc11_ != null)
            {
               _loc12_ = _loc11_.getRect(_loc11_);
               _loc11_.x = var_1462 - _loc12_.width / 2;
               _loc11_.y = var_1463 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_447,var_109,var_110,-1,RoomObjectCategoryEnum.const_188));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_66 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_276,const_487);
                  var_66.handleRoomObjectEvent(_loc14_,var_109,var_110);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = getRoomObjectImage(var_109,var_110,param1,param2,new Vector3d(),1,null);
         }
         else if(var_9 != null)
         {
            _loc8_ = null;
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_109,var_110,var_1195);
         if(_loc7_ != null)
         {
            _loc10_ = getOverlaySprite(_loc7_);
            removeOverlayIconSprite(_loc10_,const_275);
            _loc11_ = addOverlayIconSprite(_loc10_,const_275,_loc6_.data);
            if(_loc11_ != null)
            {
               _loc11_.x = var_1462 - _loc6_.data.width / 2;
               _loc11_.y = var_1463 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_9 != null)
         {
            ...
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_320,param1.image,true);
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_966,param1.adWarningL,true);
            var_9.addGraphicAsset(var_9.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_924,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_951,RoomObjectVariableEnum.const_320,param1.clickUrl);
      ...
      {
         var _loc3_:String = getRoomIdentifier(param1,param2);
         var _loc4_:RoomInstanceData = var_294.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            var_294.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_9 != null)
         {
            _events.addEventListener(RoomContentLoader.const_622,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_66 != null)
         {
            var_66.cancelRoomObjectInsert(var_109,var_110);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_41.getRoom(const_486);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_788);
               ...
               var_564.freeNumber(_loc10_ - 1);
               _loc13_ = var_986.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_109,var_110,const_276,RoomObjectCategoryEnum.const_60,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.method_2(const_276,_loc12_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_919,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_730,1,true);
            _loc13_ = parseInt(var_97.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1014,_loc13_,true);
            if(var_9 != null)
            {
         ...
         {
            _loc9_ = _loc7_.method_2(const_276,const_487,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_730,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_516,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_705,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_551,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_628,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_507,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_925,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_593,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_602,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_583,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_404,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_204);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_693,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_517,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_693,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_517,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_936,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_929,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.method_2(const_756,const_1060,RoomObjectCategoryEnum.const_273);
         _loc7_.method_2(const_757,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_273);
         return _loc7_;
      }

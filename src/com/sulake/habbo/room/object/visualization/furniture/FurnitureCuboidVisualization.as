   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:int) : void
      {
         ...
         while(_loc5_ < var_106.length)
         {
            ...
            _loc9_ = var_106[_loc5_] as FurniturePlane;
            if(_loc9_ != null)
            {
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc6_)
               {
                  _loc10_.assetName = _loc7_ + "_" + _loc3_.getInstanceId() + "_" + var_1445;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_106 != null)
         {
            ...
            {
               _loc2_ = var_106[_loc1_] as FurniturePlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      protected function initializePlanes() : void
      {
         ...
         var _loc3_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_300);
         var _loc4_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_434);
         var _loc5_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_600);

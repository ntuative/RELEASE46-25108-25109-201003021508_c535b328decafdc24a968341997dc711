package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_1338:int = 0;
      
      public static const const_287:int = 1000;
      ...
      private var var_1231:int = 360;
      
      private var var_2004:int = 0;
      
      private var var_698:DirectionData = null;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1231 / 2) % 360 / var_1231;
         if(var_228.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         var _loc4_:int = -1;
         var _loc5_:int = 0;
         while(_loc5_ < var_228.length)
         {
            _loc6_ = int(var_228.getKey(_loc5_)) * var_1231;
         ...
         if(_loc4_ >= 0)
         {
            return int(var_228.getKey(_loc4_));
         }
         return const_1338;
      }
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_903);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_991);
                  break;
               case "DARKEN":
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = var_228.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(var_228 != null)
         {
            ...
            {
               _loc2_ = var_228.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc7_ = int(_loc6_.@id);
            _loc8_ = _loc6_.layer;
            if(var_228.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            ...
            var_228.add(String(_loc7_),_loc3_);
            var_1230 = -1;
            var_698 = null;
            _loc5_++;
         }

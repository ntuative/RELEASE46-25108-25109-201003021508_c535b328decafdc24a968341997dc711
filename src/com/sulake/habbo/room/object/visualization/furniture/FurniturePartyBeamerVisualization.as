package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_344:int = 2;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1010[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1012[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1010 = new Array();
         var_1010.push(Math.random() * _loc2_ * 1.5);
         var_1010.push(Math.random() * _loc2_ * 1.5);
         var_1009 = new Array();
         var_1009.push(1);
         var_1009.push(-1);
         var_1011 = new Array();
         var_1011.push(const_1073);
         var_1011.push(const_1074);
         var_1012 = new Array();
         var_1012.push(getRandomAmplitudeFactor());
         var_1012.push(getRandomAmplitudeFactor());
      }

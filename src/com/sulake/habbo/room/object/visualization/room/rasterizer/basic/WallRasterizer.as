package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class WallRasterizer extends PlaneRasterizer
   {
      ...
      private function parseWalls(param1:XML) : void
      {
         ...
         while(_loc3_ < _loc2_.length())
         {
            ...
            if(XMLValidator.checkRequiredAttributes(_loc4_,["id"]))
            {
               ...
               if(var_324.getValue(_loc5_) == null)
               {
                  var_324.add(_loc5_,_loc7_);
               }
               else
               {
                  _loc7_.dispose();
      ...
      {
         var _loc13_:WallPlane = var_324.getValue(param2);
         if(_loc13_ == null)
         {
            _loc13_ = var_324.getValue(const_739);
         }
         if(_loc13_ == null)
         {
            return null;
      ...
      override public function dispose() : void
      {
         ...
         if(var_324 != null)
         {
            ...
            {
               _loc2_ = var_324.getWithIndex(_loc1_) as WallPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }

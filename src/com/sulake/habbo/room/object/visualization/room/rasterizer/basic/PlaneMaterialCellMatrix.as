package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1352:int = const_313;
      ...
      public static const const_540:int = 6;
      
      public static const const_250:int = const_100;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1436 == const_100)
         {
            _loc5_ = new Rectangle(0,0,var_26.width,var_458);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_458,var_26.width,var_458);
         }
         ...
         if(isStatic)
         {
            if(var_26 != null)
            {
               if(var_26.width == param2 && var_26.height == param3 && Vector3d.isEqual(var_778,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_458,param6,param7);
                     return param1;
                  }
                  return var_26;
               }

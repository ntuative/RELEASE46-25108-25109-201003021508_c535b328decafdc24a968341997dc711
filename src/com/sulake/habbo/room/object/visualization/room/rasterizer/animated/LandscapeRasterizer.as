package com.sulake.habbo.room.object.visualization.room.rasterizer.animated
{
   ...
   public class LandscapeRasterizer extends PlaneRasterizer
   {
      ...
      private static const const_344:int = 500;
      ...
      private function parseLandscapes(param1:XML) : void
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            if(XMLValidator.checkRequiredAttributes(_loc6_,["id"]))
            {
               ...
               if(var_344.getValue(_loc7_) == null)
               {
                  var_344.add(_loc7_,_loc9_);
               }
               else
               {
                  _loc9_.dispose();
      ...
      {
         var _loc13_:LandscapePlane = var_344.getValue(param2);
         if(_loc13_ == null)
         {
            _loc13_ = var_344.getValue(const_739);
         }
         if(_loc13_ == null)
         {
            return null;
         ...
         var _loc15_:* = null;
         if(!_loc13_.isStatic(param5) && const_344 > 0)
         {
            _loc15_ = new PlaneBitmapData(_loc14_,Math.round(param12 / const_344) * const_344 + const_344);
         }
         else
         {
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_344.length)
            {
               _loc2_ = var_344.getWithIndex(_loc1_) as LandscapePlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }

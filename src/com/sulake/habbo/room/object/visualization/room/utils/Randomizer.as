package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1535:int = 16777216;
      
      public static const const_1526:int = 1;
       
      
      private var var_2333:int = 69069;
      
      private var var_1105:int = 1;
      
      private var var_2332:int = 5;
      
      private var var_1375:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1375 * param2);
      }
      ...
      {
         var _loc1_:int = var_2333 * var_1105 + var_2332;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }

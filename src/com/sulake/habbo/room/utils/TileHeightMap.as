package com.sulake.habbo.room.utils
{
   public class TileHeightMap
   {
      ...
      {
         var _loc3_:* = null;
         if(param1 >= 0 && param1 < var_136 && param2 >= 0 && param2 < var_135)
         {
            _loc3_ = var_869[param2] as Array;
      ...
      public function setTileBlocking(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         if(param1 >= 0 && param1 < var_136 && param2 >= 0 && param2 < var_135)
         {
            _loc4_ = var_718[param2] as Array;
      ...
      public function validateLocation(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:int) : Boolean
      {
         ...
         if(param1 + param3 > var_136 || param2 + param4 > var_135)
         {
            return false;
         }
         if(param5 < 0 || param5 >= var_136)
         {
            param5 = 0;
         }
         if(param6 < 0 || param6 >= var_135)
         {
            param6 = 0;
         }
         if(param7 > var_136)
         ...
         if(param5 + param7 >= var_136)
         {
            param7 = var_136 - param5;
         }
         if(param6 + param8 >= var_135)
         {
            param8 = var_135 - param6;
         }
         var _loc9_:int = 0;
         var _loc10_:int = 0;
         var _loc11_:* = null;
         ...
         {
            _loc11_ = var_718[_loc10_] as Array;
            _loc9_ = param1;
      ...
      public function getTileBlocking(param1:int, param2:int) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < var_136 && param2 >= 0 && param2 < var_135)
         {
            _loc3_ = var_718[param2] as Array;
            return Boolean(_loc3_[param1]);
         }
         return true;
      }
      ...
      public function setIsRoomTile(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         if(param1 >= 0 && param1 < var_136 && param2 >= 0 && param2 < var_135)
         {
            _loc4_ = var_869[param2] as Array;
            _loc4_[param1] = param3;
            if(!param3)
            {

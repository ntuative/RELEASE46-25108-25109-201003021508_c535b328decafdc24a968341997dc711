package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1055:int = -1000000000;
      
      private var var_1294:Boolean = true;
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_949,_loc3_.status);
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_516);
         var _loc8_:int = 0;
      ...
      private function onCarryObject(param1:IMessageEvent) : void
      {
         ...
         if(param1 is CarryObjectMessageEvent)
         {
            ...
            _loc3_ = new RoomObjectAvatarCarryObjectUpdateMessage(_loc2_.itemType,_loc2_.method_10);
            var_7.updateObjectUserState(_loc2_.roomId,_loc2_.roomCategory,_loc2_.userId,_loc3_);
         }
      }
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            if(_loc2_.avatar != null)
            {
               ...
               {
                  case SlideObjectMessageData.const_1016:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_999:
                     _loc10_ = "std";
               }

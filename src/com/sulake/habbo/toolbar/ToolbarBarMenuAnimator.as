package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1046:Number = 90;
      
      private static const const_768:int = 50;
      
      private static const const_1050:Number = 25;
      
      private static const const_1076:int = 50;
      
      private static const const_179:Boolean = true;
       
      
      private var var_586:Timer;
      
      private var var_1016:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1016 = param2;
         var_586 = new Timer(const_1050);
         var_586.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_473.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_473.splice(_loc3_,1);
            var_472.splice(_loc3_,1);
         }
         var_472.push(param1.name);
         var_473.push(param2);
         param1.addEventListener(WindowEvent.const_465,windowEventListener);
         param1.addEventListener(WindowEvent.const_195,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_473[var_472.indexOf(param1)];
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1016.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_303.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_303.splice(var_303.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_1016.getIconLoc(param1.iconId);
      ...
      {
         return var_472[var_473.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_303[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_585[_loc3_] = new Array();
            }
            if(var_585[_loc3_].indexOf(param1) < 0)
            {
               var_585[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_768 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_768 || param1.desktop.height - param1.y < const_1076;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         {
            if(var_472[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_585[_loc3_].length)
                  {
                     repositionWindow(var_585[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }

package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_1045:Boolean = true;
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_201 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_57,HabboWindowStyle.const_994,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_1045 = String(_loc7_.relocate_by_drag.@state) == "HabboNavigatorCom_rico_ob5_png";
         if(var_1045)
         {
         ...
         var_1282 = _loc7_.toolbar.@margin_bottom;
         var_1548 = _loc7_.toolbar.@min_group_margin;
         var_1547 = _loc7_.toolbar.@margin_to_extrabar;
         ...
         createGroupsFromXmlList(_loc8_,var_277,param1,param2,_window,var_276);
         createGroupsFromXmlList(_loc9_,var_595,param1,param2,var_201,var_276);
         alignWindows();
      }
      ...
      public function dispose() : void
      {
         ...
         while(false)
         {
            _loc1_ = var_277.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         while(false)
         {
            _loc1_ = var_595.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(_window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_137,var_493,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1548,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1282) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1548,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1282) / -1));
         ...
         _loc2_ = 0;
         while(_loc2_ < var_595.length)
         {
            _loc3_ = var_595[_loc2_];
            if(_loc3_ != null)
            {
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_137,var_493);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_595.length)
         {
            _loc2_ = var_595[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_493);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_137,var_493);
         }
      }

package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_312.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      
      private function onSetToolbarIconEvent(param1:HabboToolbarSetIconEvent) : void
      {
         var _loc2_:* = null;
         if(_view != null && var_32)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_112,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_812,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_159,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_169,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_44,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_395,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_675,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_930,onHideWindowEvent);
         var_32 = true;
      ...
      private function onAnimateWindowEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(var_32 && _view != null)
         {
            if(param1.type == HabboToolbarShowMenuEvent.const_44)
            {

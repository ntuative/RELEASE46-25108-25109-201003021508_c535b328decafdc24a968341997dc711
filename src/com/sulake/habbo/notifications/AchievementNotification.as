package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1618 = param2;
         var_352 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_119,onBadgeImageReady);
         ...
         var_199 = param5.getKey("notifications.text.achievement");
         registerBadgeParameters("notifications.text.achievement_facebook");
         var_1665 = param5.getKey("notifications.text.achievement_facebook");
         setText("achievement_info",var_199);
      ...
      public function dispose() : void
      {
         if(var_352 != null)
         {
            var_352.events.removeEventListener(BadgeImageReadyEvent.const_119,onBadgeImageReady);
            var_352 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_632,var_1665);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_632,var_632));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_632,var_632));
         _localizations.registerParameter(param1,"level",var_1618.toString());
         _localizations.registerParameter(param1,"name",var_352.userName);
         _localizations.registerParameter(param1,"realname",var_352.realName);
      }
   }
}

package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_72,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_679);
         _loc2_.refreshViews();
         var_8.notifyChangedEffects();
      }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_166);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_8.setInventoryCategoryInit(InventoryCategory.const_317);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_72);
         ...
         while(_loc12_ < _loc3_.length)
         {
            ...
            if(_loc9_.indexOf(_loc6_.stripId) == -1)
            {
               ...
               {
                  _loc5_ = new FloorItem(_loc6_.stripId,_loc6_.classId,_loc6_.objId,_loc6_.category,_loc6_.isGroupable,_loc6_.isTradeable,_loc6_.isRecyclable,_loc6_.method_7,_loc6_.stuffData,_loc6_.extra,_loc6_.expiryTime,0,0,0,_loc6_.slotId,_loc6_.songId);
               }
               else
               {
                  ...
                  _loc5_ = new WallItem(_loc6_.stripId,_loc6_.classId,_loc6_.objId,_loc6_.category,_loc6_.isGroupable,_loc6_.isTradeable,_loc6_.isRecyclable,_loc6_.method_7,_loc6_.stuffData,_loc6_.extra);
               }
               if(_loc7_.length == 0)
               {
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_8.toggleInventorySubPage(InventorySubCategory.const_246);
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_8.setInventoryCategoryInit(InventoryCategory.const_371);
         var _loc4_:FurniModel = var_8.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();

package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceView implements IGetImageListener
   {
      ...
      public function showMakeOffer(param1:IItem) : void
      {
         ...
         var_2195 = _localization.getKey("roomItem.name." + param1.type);
      ...
      {
         _localization.registerParameter("inventory.marketplace.confirm_offer.info","furniname",var_2195);
         _localization.registerParameter("inventory.marketplace.confirm_offer.info","price",var_1568.toString());
      ...
      private function clickHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowEvent.const_141)
         {
      ...
      {
         var _loc1_:* = null;
         if(false && "HabboNavigatorCom_rico_ob5_png" == _config.getKey("client.credits.embed.enabled"))
         {

package com.sulake.habbo.inventory.effects
{
   ...
   public class EffectsModel implements IInventoryModel
   {
      ...
      private var var_839:EffectListProxy;
      ...
      public function EffectsModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IHabboLocalizationManager)
      {
         ...
         var_839 = new EffectListProxy(this,1);
         _inactiveEffectsProxy = new EffectListProxy(this,0);
         _view = new EffectsView(this,param2,param4,param5,var_839,_inactiveEffectsProxy);
      }
      ...
      public function stopUsingAllEffects(param1:Boolean = true, param2:Boolean = true) : void
      {
         ...
         if(param1)
         {
            var_11.communication.getHabboMainConnection(null).send(new AvatarEffectSelectedComposer(-1));
         }
         if(param2)
         {
            refreshViews();
      ...
      {
         var_11.communication.getHabboMainConnection(null).send(new AvatarEffectActivatedComposer(param1));
      }
      ...
      public function useEffect(param1:int) : void
      {
         ...
         {
            _loc2_.isInUse = true;
            var_11.communication.getHabboMainConnection(null).send(new AvatarEffectSelectedComposer(param1));
            refreshViews();
         }
      }

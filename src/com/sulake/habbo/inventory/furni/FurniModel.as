package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1100:int = 100;
      
      public static const const_297:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_486 = new Timer(const_1100,1);
         var_486.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return var_11.getSubCategoryViewId() == InventorySubCategory.const_246;
      }
      ...
      {
         return var_11.canUserOfferToTrade();
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_407.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_407.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_640)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_486 != null)
            {
               var_486.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_486.stop();
               var_486 = null;
            }
            if(var_134 != null)
            {
               var_134.removeEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
               var_134.stop();
               var_134 = null;
            }
            if(var_712 != null)
      ...
      private function requestSelectedFurniToMover(param1:IItem) : void
      {
         ...
         {
            var_1026 = param1.ref;
            if(!var_11.recyclerModel.running)
            {
               requestClose();
            }
            var_862 = true;
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_301)
         {
         ...
         if(var_712 == null)
         {
            var_712 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_712.clone() as IWindowContainer;
         return new GroupItem(param1,param2,param3,_loc11_,_roomEngine,_loc9_.clone(),var_11.recyclerModel.running,param4,param5,_loc7_,param6);
      }
      ...
      public function requestSelectedFurniToTrading() : void
      {
         ...
         var _loc3_:TradingModel = var_11.tradingModel;
         if(_loc3_ != null)
         {
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_246:
               ...
               break;
            case InventorySubCategory.const_1005:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            var_134 = new Timer(param1,1);
            var_134.addEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
            var_134.start();
         }
         else
         {
      ...
      {
         var_11.checkCategoryInitilization(InventoryCategory.const_371);
      ...
      public function categorySwitch(param1:String) : void
      {
         if(param1 == InventoryCategory.const_72 && false)
         {
            ...
            {
               case const_40:
                  var_11.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_FURNI));
                  break;
               case const_41:
                  var_11.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_POSTERS));
                  break;
               case const_297:
                  var_11.toggleInventoryPage(InventoryCategory.const_166);
            }
         }
      }
      ...
      public function updateLocks() : void
      {
         ...
         var _loc3_:RecyclerModel = var_11.recyclerModel;
         if(_loc3_ != null)
         {
      ...
      {
         if(var_862 && param1.type == RoomEngineObjectEvent.const_216)
         {
            var_11.showView();
            var_862 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_301 || _loc3_.category == FurniCategory.const_285 || _loc3_.category == FurniCategory.const_323)
         {
            if(param1)
            {
               return false;
      ...
      {
         var_407 = new Map();
         var_407.add(const_40,new Array());
         var_407.add(const_41,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }

package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2274:BitmapData;
      
      protected var var_932:Boolean;
      
      protected var var_2265:Boolean;
      
      protected var var_1969:int;
      ...
      protected var var_365:BitmapData;
      
      private const const_1421:Number = 0.2;
      
      protected var var_1373:Boolean;
      
      private const const_1422:Number = 1;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_640)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1425));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1362);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1421;
               _loc1_.blend = const_1421;
            }
            else
            {
               _window.blend = const_1422;
               _loc1_.blend = const_1422;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1373 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2274;
               _loc5_.visible = true;
            }
            else
            {

package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_340:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         var_340 = new ItemPopupCtrl(_loc8_,_assetLibrary);
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "button_accept":
                  switch(var_22.state)
                  {
                     case TradingModel.const_155:
                        if(var_22.otherUserItems.length == 0 && true)
                        {
                           alertPopup(const_889);
                        }
                        if(false)
                        {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_819)
            {
            ...
            var_340.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_358);
            var_340.show();
         }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_173)
            {
               var_173.removeEventListener(TimerEvent.TIMER,timerEventHandler);
               var_173.stop();
               var_173 = null;
            }
            if(var_340 != null)
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1508 == null)
         {
            var_1508 = createMinimizedWindow();
         }
         if(!var_1986)
         {
            return var_64;
      ...
      public function startConfirmCountdown() : void
      {
         if(var_173 == null)
         {
            var_173 = new Timer(1000,3);
            var_173.addEventListener(TimerEvent.TIMER,timerEventHandler);
         }
         var_173.reset();
         var_173.repeatCount = 3;
         var_173.start();
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_64)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_766) : uint(const_765);
            }

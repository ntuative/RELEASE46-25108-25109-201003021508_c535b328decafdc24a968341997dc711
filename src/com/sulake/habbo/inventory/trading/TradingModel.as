package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_244:uint = 3;
      
      public static const const_155:uint = 1;
      
      public static const const_160:uint = 0;
      
      public static const const_1276:uint = 9;
      
      public static const const_187:uint = 5;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_446 = false;
         var_629 = false;
         var_44.updateItemList(var_630);
         var_44.updateItemList(var_1122);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_44.alertPopup(TradingView.const_972);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_630)
            {
               var_446 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_629 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_44.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_630)
            {
               var_44.alertPopup(TradingView.const_976);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_32 + " NEW STATE: " + param1 + " OWN: " + var_446 + " OTHER: " + var_629);
         ...
         {
            case const_160:
               if(param1 == const_155 || param1 == const_187)
               {
                  var_32 = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         if(var_212 == null || false)
         {
            return _loc1_;
         }
         var _loc4_:int = 0;
         while(_loc4_ < var_212.length)
         {
            _loc2_ = var_212.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      {
         var_44.setMinimized(param1 != InventoryCategory.const_72);
         var_8.updateSubView();
      }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         else
         {
            ...
            if(var_212.getValue(_loc6_) == null)
            {
               return false;
            }
            _communication.getHabboMainConnection(null).send(new AddItemToTradeComposer(param1));
      ...
      public function close() : void
      {
         if(var_596)
         {
            if(var_32 != const_160 && var_32 != const_187)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_160;
            var_8.toggleInventorySubPage(InventorySubCategory.const_1005);
            var_596 = false;
         }
         var_44.setMinimized(false);
      }

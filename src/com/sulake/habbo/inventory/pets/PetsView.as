package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private var var_286:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_516 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_528 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_528.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_286 != null)
         {
            var_286.setSelected(false);
         }
         var_286 = param1;
         if(var_286 != null)
         {
            var_286.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_286.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_528.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_516.removeGridItem(_loc2_.window);
         if(var_286 == _loc2_)
         {
            var_286 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_528.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_516.addGridItem(_loc2_.window);
            var_528.add(param1.id,_loc2_);
            if(var_286 == null)
            {
               selectFirst();
            }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         else
         {
            ...
            if(_loc14_ < 10)
            {
               _loc4_ = "${pet.race." + _loc13_.method_9 + ".00" + _loc14_ + "}";
            }
            else if(_loc14_ < 100)
            {
               _loc4_ = "${pet.race." + _loc13_.method_9 + ".0" + _loc14_ + "}";
            }
            _loc5_ = true;
         }

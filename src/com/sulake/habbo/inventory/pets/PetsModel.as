package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_166 && false)
         {
            var_11.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_PETS));
         }
      }
      ...
      {
         var_11.furniModel.switchCategory(param1);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(var_1288 && param1.type == RoomEngineObjectEvent.const_216)
         {
            var_11.showView();
            var_1288 = false;
         }
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         if(var_11.roomSession.isRoomOwner)
         {
            var_1288 = _roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_33,RoomObjectTypeEnum.const_302,_loc3_.figure);
            var_11.closeView();
            return;
         }
         if(!var_11.roomSession.arePetsAllowed)
         {
            return;
         }
         if(!param2)
      ...
      {
         if(var_1013.add(param1.id,param1))
         {
            _view.addPet(param1);
         }
      }

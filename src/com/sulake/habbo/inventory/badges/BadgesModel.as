package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_819.length)
         {
            if(var_819[_loc2_] == param1)
            {
               var_819.splice(_loc2_,1);
      ...
      public function categorySwitch(param1:String) : void
      {
         ...
         {
            var_11.events.dispatchEvent(new Event(HabboInventoryTrackingEvent.HABBO_INVENTORY_TRACKING_EVENT_BADGES));
         }
      }
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = var_352.getBadgeImage(param1);
            var_263.push(_loc8_);
            if(param2)
            {

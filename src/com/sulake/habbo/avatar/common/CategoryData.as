package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function selectColorIndex(param1:int) : AvatarEditorGridColorItem
      {
         ...
         if(var_61.length <= _selectedColorLayerIndex)
         {
            return null;
         }
         if(!_palette)
         ...
         var_61[_selectedColorLayerIndex] = param1;
      ...
      {
         return _data[var_633] as AvatarEditorGridPartItem;
      }
      
      public function method_14(param1:int) : int
      {
         var _loc2_:int = 0;
         if(param1 > -1)
         {
      ...
      public function selectItemIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(var_633 >= 0 && _data.length > var_633)
         {
            _loc3_ = _data[var_633];
      ...
      public function selectColorLayerIndex(param1:int) : void
      {
         ...
         while(var_61.length <= param1)
         {
            var_61.push(-1);
         }
         selectColorIndex(var_61[_selectedColorLayerIndex]);
      }
      ...
      public function selectColorIds(param1:Array) : void
      {
         ...
         var_61 = new Array(param1.length);
         var _loc3_:int = 0;

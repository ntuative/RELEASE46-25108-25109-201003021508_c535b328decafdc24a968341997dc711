package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_648.width,var_648.height,true,0);
            _loc1_.bitmap.copyPixels(var_648,var_648.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_771.width,var_771.height,true,0);
            _loc4_ = var_771.clone();
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(false)
               {
                  _loc5_.bitmap.copyPixels(var_955,var_955.rect,new Point(0,0),null,null,true);
               }
               else
               {
                  _loc5_.bitmap.copyPixels(var_954,var_954.rect,new Point(0,0),null,null,true);
               }
            }
         }
      }

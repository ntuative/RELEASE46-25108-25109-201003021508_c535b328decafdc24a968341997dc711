package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem
   {
      ...
      private const const_1614:int = 16777215;
      
      private var _isSelected:Boolean = false;
      
      private var var_955:BitmapData;
      
      private const const_1615:int = 13421772;
      
      private var var_829:Rectangle;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         var_955 = _loc6_.content as BitmapData;
         if(param3 == null)
         {
            var_365 = new BitmapData(1,1,true,16777215);
         }
         if(param3 != null)
         {
            _loc8_ = param3.parts;
            ...
            {
               var_1504 = Math.max(var_1504,_loc7_.colorLayerIndex);
            }
         }
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(var_580 != null && false)
         {
            ...
            if(_loc6_ != null)
            {
               ...
               _loc6_.bitmap.copyPixels(var_955,var_955.rect,new Point(0,0),null,null,true);
            }
         }
         if(isSelected)
         {
            _window.color = const_1615;
         }
         else
         {
            _window.color = const_1614;
         }
         _window.invalidate();
      }
      ...
      private function analyzeLayers() : Boolean
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_882 + "_" + FigureData.const_254;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         _loc1_ = new BitmapData(var_829.width,var_829.height,true,16777215);
         var _loc6_:Array = partSet.parts.concat().sort(sortByDrawOrder);
         for each(_loc2_ in _loc6_)
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_882 + "_" + FigureData.const_254;
            ...
            if(_loc4_ != null)
            {
               ...
               if(var_1503 && _loc2_.colorLayerIndex > 0)
               {

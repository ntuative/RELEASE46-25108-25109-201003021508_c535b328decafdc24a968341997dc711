   ...
   public class CategoryBaseView
   {
      ...
      protected function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result && result.length)
         {
            ...
            {
               bmpWindow.bitmap = new BitmapData(bmpWindow.width,bmpWindow.height,false,AvatarEditorView.var_2250);
      ...
      public function showColorLayerTabAmount(param1:String, param2:int) : void
      {
         ...
         if(var_36)
         {
            _loc3_ = var_36[param1] as AvatarEditorGridView;
            if(_loc3_)
            {
      ...
      protected function changeToCurrentTab() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_36[var_282];
         if(_loc2_ == null)
         {
            return;
         }

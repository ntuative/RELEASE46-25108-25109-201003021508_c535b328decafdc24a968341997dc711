package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1425:int = 60000;
      ...
      private var var_889:IAvatarImage;
      ...
      public function getAnimationDataInFrame(param1:String, param2:int) : AnimationLayerData
      {
         ...
         return var_70.getBodyPartData(_loc4_.definition.state + "." + _loc4_.actionParameter,param2,param1);
      }
      ...
      public function getBodyPartCache(param1:String) : AvatarImageBodyPartCache
      {
         ...
         var _loc2_:AvatarImageBodyPartCache = var_140.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            var_140.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         {
            _loc15_ = var_70.getBodyPartData(_loc5_.definition.state + "." + _loc5_.actionParameter,param2,param1);
            if(_loc15_ != null)
            {
               ...
               if(_loc15_.type == AnimationLayerData.const_554)
               {
                  _loc6_ = _loc15_.action;
                  _loc4_ = _loc8_;
               }
               else if(_loc15_.type == AnimationLayerData.const_444)
               {
                  _loc4_ = _loc8_;
               }
               _loc7_ = true;
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_70.getParts(param1,(var_889 as AvatarImage).getFigure(),_loc6_,var_1349,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_70.getCanvas(var_185,var_1349);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1292[param1])
            {
            ...
            _loc10_ = var_185 + "_" + _loc18_.assetPartDefinition + "_" + _loc11_ + "_" + _loc12_ + "_" + _loc23_ + "_" + _loc13_;
            _loc16_ = _assets.getAssetByName(_loc10_) as BitmapDataAsset;
            if(_loc16_ == null)
            {
               _loc10_ = var_185 + "_std_" + _loc11_ + "_" + _loc12_ + "_" + _loc23_ + "_0";
               _loc16_ = _assets.getAssetByName(_loc10_) as BitmapDataAsset;
            }
            if(_loc16_ == null)
            {
            ...
            else
            {
               ...
               {
                  _loc34_ = var_70.renderManager.paletteManager.getPalette(_loc7_.paletteMapId);
               ...
               if((_loc32_ == AvatarAction.const_816 || _loc32_ == AvatarAction.const_530) && (_loc6_ == AvatarBodyPartType.const_307 || _loc6_ == AvatarBodyPartType.const_1289 || _loc6_ == AvatarBodyPartType.const_1143) && _loc7_.color != null)
               {
         ...
         if(_loc20_)
         {
            if(var_185 == AvatarScaleType.const_51)
            {
               _loc30_.x += 67;
            }
            else
      ...
      public function setAction(param1:IActiveActionData) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:Array = var_70.getActiveBodyPartIds(param1);
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         if(var_140 != null)
         {
            _loc2_ = var_140.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc4_ = var_140.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc4_ != null)
               {
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Array = var_70.getBodyPartsUnordered(param1);

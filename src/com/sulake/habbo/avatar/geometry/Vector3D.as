package com.sulake.habbo.avatar.geometry
{
   public class Vector3D
   {
      ...
      public function cross(param1:Vector3D) : Vector3D
      {
         ...
         _loc2_.y = var_86 * param1.x - var_85 * param1.z;
      ...
      {
         return Math.sqrt(var_85 * var_85 + _y * _y + var_86 * var_86);
      }
      ...
      {
         return var_85 * param1.x + _y * param1.y + var_86 * param1.z;
      }
      ...
      {
         return "Vector3D: (" + var_85 + "," + _y + "," + var_86 + "," + var_1080 + ")";
      }

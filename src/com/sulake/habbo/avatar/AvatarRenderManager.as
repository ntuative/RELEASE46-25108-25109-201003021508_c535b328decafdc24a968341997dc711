package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_1007:PaletteManager;
      
      private var var_692:PetDataManager;
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_301.getValue(AvatarType.const_90) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(var_97);
         }
         _loc2_ = var_301.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(var_97);
         }
      ...
      private function init() : void
      {
         ...
         var_692 = new PetDataManager(_loc1_,_loc3_);
         var_1007 = new PaletteManager(_loc1_,_loc3_);
         var _loc4_:XML = _assets.getAssetByName("HabboAvatarPetFigure").content as XML;
         var_692.populateFigureData(_loc4_);
         _loc5_ = new AvatarStructure(this,assets,_loc1_,AvatarType.const_90);
         _loc5_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_301.add(AvatarType.const_90,_loc5_);
         _loc5_ = new AvatarStructure(this,assets,_loc1_,AvatarType.PET);
         _loc5_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_301.add(AvatarType.PET,_loc5_);
         initHardCodedAliases();
      }
      
      public function get petDataManager() : IPetDataManager
      {
         return var_692 as IPetDataManager;
      }
      
      public function set mode(param1:String) : void
      {
         var_626 = param1;
         if(var_626 == RenderMode.const_1265)
         {
            init();
         }
      }
      ...
      {
         var _loc5_:String = var_692.createAvatarFigureStringNew(param1,param2,param3);
         var _loc6_:AvatarStructure = var_301.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:AvatarStructure = var_301.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = var_301.getValue(AvatarType.const_90) as AvatarStructure;
         if(_loc3_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc3_,var_18,param1,param2,AvatarType.const_90);
      }

package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_1198:BitmapData;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         var_1198 = _loc4_.content as BitmapData;
         if(_window != null)
         {
      ...
      public function udpate(param1:BitmapData) : void
      {
         ...
         var_488.bitmap.copyPixels(var_1198,var_1198.rect,new Point(0,0 - 0 - 8));
         var_488.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
      }
   }
}

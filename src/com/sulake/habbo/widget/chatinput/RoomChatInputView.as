package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_496:int = 16;
      
      private static const const_1053:int = 20;
      
      private static const const_347:int = 10;
      
      private static const const_1052:int = 40;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_969 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1804 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1803 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_664 = new Timer(1000,1);
         var_664.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_783 = new Timer(5000,1);
         var_783.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_57,HabboWindowStyle.const_39,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_142,windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_43,onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_141,onInputChanged);
         _window.addEventListener(WindowEvent.const_465,onWindowMoved);
         var_1168 = true;
         var_125 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1805 = _loc2_.width + const_496 + _loc6_.width + const_1053;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1052,_loc8_.width) + const_496);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_969 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_125 = "";
               }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_461);

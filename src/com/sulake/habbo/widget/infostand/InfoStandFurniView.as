package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      public function set image(param1:BitmapData) : void
      {
         ...
         var _loc2_:IBitmapWrapperWindow = var_103.getListItemByName("image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:ITextWindow = var_103.getListItemByName("expiration_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_103.getListItemByName("expiration_spacer") as IWindowContainer;
      ...
      {
         var _loc2_:ITextWindow = var_103.getListItemByName("description_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }

package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_896:TagListRenderer;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         var_896 = new TagListRenderer(param1,onTagSelected);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         _window.name = param1;
         var _loc6_:IBitmapWrapperWindow = var_234.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc7_:IWindow = var_234.findChildByTag("close");
         if(_loc7_ != null)
         {
         ...
         while(_loc8_ < 5)
         {
            _loc10_ = var_234.findChildByName("badge_" + _loc8_);
            if(_loc10_ != null)
            {
         ...
         _loc10_ = var_234.findChildByName("badge_group");
      ...
      {
         var _loc1_:IWindowContainer = var_103.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         var _loc2_:ITextWindow = var_103.getListItemByName("realname_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:IWindowContainer = var_103.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         var _loc2_:ITextWindow = var_103.getListItemByName("motto_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_103.getListItemByName("motto_spacer") as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = var_103.getListItemByName("tags_container") as IWindowContainer;
         var _loc4_:IWindowContainer = var_103.getListItemByName("tags_spacer") as IWindowContainer;
         ...
         if(param1.length != 0)
         {
            _loc3_.height = var_896.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      {
         var _loc4_:* = null;
         var _loc2_:ITextWindow = var_103.getListItemByName("handitem_txt") as ITextWindow;
         var _loc3_:IWindowContainer = var_103.getListItemByName("handitem_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.TRADE_REASON_NO_OWN_RIGHT:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_857:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_911:
      ...
      {
         var _loc2_:ITextWindow = var_103.getListItemByName("xp_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_103.getListItemByName("xp_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc3_:IWindowContainer = var_103.getListItemByName("image_and_badges_container") as IWindowContainer;

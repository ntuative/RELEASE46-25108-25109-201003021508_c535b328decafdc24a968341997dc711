package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      {
         var _loc2_:* = null;
         if(var_1164 != null && var_1164.indexOf(param1) != -1)
         {
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_782 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_782 += param1.height + const_1611;
            return fit(param1);
         }
         param1.offset(_offsetX,var_782);
         _offsetX += param1.width + const_1610;
         return true;
      }

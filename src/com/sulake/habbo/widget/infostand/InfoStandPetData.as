package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetData
   {
      ...
      public function setData(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         _name = param1.name;
         var_1246 = param1.id;
         _type = param1.method_9;
         var_1621 = param1.petRace;
         _image = param1.image;
         var_1623 = param1.isOwnPet;
         var_1620 = param1.ownerId;
         _ownerName = param1.ownerName;
         _canOwnerBeKicked = param1.canOwnerBeKicked;
         var_1618 = param1.level;
         var_1624 = param1.levelMax;
         var_1615 = param1.experience;
         var_1614 = param1.experienceMax;
         _energy = param1.energy;
         var_1622 = param1.energyMax;
         _nutrition = param1.nutrition;
         var_1616 = param1.nutritionMax;
         _petRespect = param1.method_4;
         var_1617 = param1.roomIndex;
         var_1619 = param1.age;
      }

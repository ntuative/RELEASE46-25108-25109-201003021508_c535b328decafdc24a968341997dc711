package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_347:int = 10;
      
      private static const const_1130:Number = 18;
      
      private static const const_1423:Number = 10;
      
      private static const const_1424:Number = 8;
       
      
      private var var_1345:Number;
      ...
      private var var_206:BitmapData;
      ...
      {
         _widget.onItemMouseOut(var_1082,var_1081,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1082,var_1081,_roomId,_roomCategory,param1);
      }
      ...
      public function define(param1:RoomWidgetChatUpdateEvent) : void
      {
         ...
         var_1082 = param1.userId;
         var_912 = param1.userName;
         var_1081 = param1.userCategory;
         _message = param1.text;
         var_1345 = param1.userX;
         var_206 = param1.userImage;
         var_1083 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         switch(var_1343)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_99:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_261:
         ...
         if(var_206 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_206.height);
         }
         ...
         var_99 = _window as IRegionWindow;
         var_99.background = true;
         var_99.alphaTreshold = 0;
         enableTooltip();
         addEventListenerToChild(var_99);
         ...
         if(var_206 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_206.width;
               _loc28_.height = var_206.height;
               _loc28_.bitmap = new BitmapData(var_206.width,var_206.height,true,0);
               _loc28_.bitmap.copyPixels(var_206,var_206.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_429 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_206.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_1083 != 0)
            {
               _loc30_ = uint(var_1083 >> 16 & 255);
               _loc31_ = uint(var_1083 >> 8 & 255);
               _loc32_ = uint(var_1083 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_347;
            }
            else
            {
               _loc19_.text = var_912 + ":";
               _loc19_.y += var_429;
               _loc19_.width = _loc19_.textWidth + const_347;
               _width += _loc19_.textWidth + const_347;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1343 == RoomWidgetChatUpdateEvent.const_261)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_912);
            }
            else if(var_1343 == RoomWidgetChatUpdateEvent.const_270)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_912);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_347 + _loc20_.textWidth + const_496;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1082,var_1081,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1082,var_1081,_roomId,_roomCategory,param1);
      }

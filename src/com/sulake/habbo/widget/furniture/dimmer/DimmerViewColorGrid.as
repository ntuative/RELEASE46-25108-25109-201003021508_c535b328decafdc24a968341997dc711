package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_445:BitmapData;
      
      private var var_1121:XML;
      
      private var var_286:IWindowContainer;
      
      private var var_371:IItemGridWindow;
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_371.destroyGridItems();
         var_286 = null;
         for each(_loc2_ in colors)
         {
            _loc3_ = param1.buildFromXML(var_1121) as IWindowContainer;
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onClick);
            _loc3_.background = true;
            _loc3_.color = 4294967295;
            _loc3_.width = var_445.width;
            _loc3_.height = var_445.height;
            var_371.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_445.width,var_445.height,true,0);
               _loc4_.bitmap.copyPixels(var_445,var_445.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_756.width,var_756.height,true,0);
      ...
      {
         var _loc2_:int = var_371.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_371.numGridItems)
         {
            return;
         }
         select(var_371.getGridItemAt(param1) as IWindowContainer);
      }
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         if(var_286 != null)
         {
            _loc2_ = var_286.getChildByName("chosen");
            if(_loc2_ != null)
            {

package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_520:DimmerViewColorGrid;
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = var_211.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            var_211.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_57,HabboWindowStyle.const_36,0 | 0,new Rectangle(const_1030,const_1029,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_520 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_354 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
         var_211 = ITabContextWindow(_window.findChildByName("tab_context"));
         selectTab(_widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < var_211.numTabItems)
         {
            _loc6_ = var_211.getTabItemAt(_loc2_);
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_520 != null)
         {
            var_520.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = var_211.selector.getSelected();
         return var_211.selector.getSelectableIndex(_loc1_);
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_354 != null)
         {
            var_354.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_1079 = _loc2_.light;
         if(var_354 != null)
         {
            var_354.setValue(var_1079);
         }
         var_422 = colors.indexOf(_loc2_.color);
         if(var_520 != null)
         {
            var_520.setSelectedColorIndex(var_422);
         }

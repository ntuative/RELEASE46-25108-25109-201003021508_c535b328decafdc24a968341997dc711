package com.sulake.habbo.widget.furniture.credit
{
   ...
   public class CreditFurniWidget extends RoomWidgetBase
   {
      ...
      private function sendRedeemMessage() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetCreditFurniRedeemMessage(RoomWidgetCreditFurniRedeemMessage.const_594,var_787);
      ...
      {
         hideInterface();
         var_787 = param1.objectId;
         var_1171 = param1.creditValue;
         showInterface();
      }
      ...
      private function showInterface() : void
      {
         ...
         windowManager.registerLocalizationParameter("widgets.furniture.credit.redeem.value","value",String(var_1171));
         ...
         _window = windowManager.createWindow("creditfurniui_container","",HabboWindowType.const_57,HabboWindowStyle.const_36,0 | 0,new Rectangle(const_1030,const_1029,2,2),null,0) as IWindowContainer;

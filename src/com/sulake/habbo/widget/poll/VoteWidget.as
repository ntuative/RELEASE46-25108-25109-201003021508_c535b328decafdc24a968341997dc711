package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_738:Array = null;
      ...
      private var var_1339:int = 30000;
      
      private var var_1341:Boolean = false;
      
      private var var_1042:Array = null;
      ...
      public function VoteWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         if(_config != null)
         {
            var_1339 = int(_config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_127,showVoteQuestion);
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_104,showVoteResult);
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_316,update);
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         var _loc8_:int = Math.max(var_47.method_1.height - 0,0);
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - var_2087;
         if(_loc2_ > var_1339)
         {
            vote();
            return;
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_127,showVoteQuestion);
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_104,showVoteResult);
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_316,update);
      }
      ...
      private function updateTimer(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((var_1339 - param1) / 1000,0);

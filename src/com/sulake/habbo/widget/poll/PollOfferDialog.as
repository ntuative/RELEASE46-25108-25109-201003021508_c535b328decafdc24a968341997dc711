package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_262:String = "POLL_OFFER_STATE_UNKNOWN";
      
      public static const const_538:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_1140:String = "POLL_OFFER_STATE_OK";
      ...
      private var var_32:String = "POLL_OFFER_STATE_UNKNOWN";
         ...
         if(_loc4_)
         {
            ...
            if(_window)
            {
               ...
               if(_loc5_)
               {
                  ...
                  if(_loc6_)
                  {
                     _window.height += _loc6_.method_1.height - _loc6_.visibleRegion.height;
                  }
               }
            }
         }
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     var_32 = const_1140;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_571,_id));
                     break;

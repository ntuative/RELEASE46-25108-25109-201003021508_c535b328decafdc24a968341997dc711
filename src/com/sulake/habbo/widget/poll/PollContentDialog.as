package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_735[var_1074] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_311)
         {
            ...
            var_311 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_311.center();
            var_311.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1074;
         if(var_1074 < var_735.length)
         {
            _loc1_ = var_735[var_1074] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_735.length);
                  _loc2_.text = _loc6_;
               }
               ...
               if(_loc5_)
               {
                  _loc7_ = _loc5_.method_1.height - _loc5_.visibleRegion.height;

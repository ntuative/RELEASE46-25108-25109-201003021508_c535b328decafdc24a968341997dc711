package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsView implements IMeMenuView
   {
      ...
      private var var_1401:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var _widget:MeMenuWidget;
      
      private var var_642:MeMenuSettingsViewSlider;
      
      private var var_1400:BitmapData;
      
      private var var_1402:BitmapData;
      
      private var var_641:Number = 1;
      
      private var var_1403:BitmapData;
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_591);
         }
         else
         {
      ...
      {
         var_641 = param1.volume;
         if(var_642 != null)
         {
            var_642.setValue(var_641);
         }
         setSoundsOffIcon();
         setSoundsOnIcon();
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            var_1403 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = _widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            var_1401 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = _widget.assets.getAssetByName("sounds_on_color") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            var_1400 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = _widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            var_1402 = (_loc5_.content as BitmapData).clone();
         }
         var_642 = new MeMenuSettingsViewSlider(this,_window.findChildByName("volume_container") as IWindowContainer,_widget.assets,0,1);
         setSoundsOffIcon();
         setSoundsOnIcon();
         ...
         _widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_682));
      }
      ...
      private function onButtonOut(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "sounds_off":
               if(var_641 != 0)
               {
                  setBitmapWrapperContent("sounds_off_icon",var_1401);
               }
               break;
            case "sounds_on":
               if(var_641 != 1)
               {
                  setBitmapWrapperContent("sounds_on_icon",var_1402);
               }
         }
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_off_icon",var_1403);
         }
         else
         {
            setBitmapWrapperContent("sounds_off_icon",var_1401);
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_on_icon",var_1400);
         }
         else
         {
            setBitmapWrapperContent("sounds_on_icon",var_1402);
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_)
         {
            ...
            case "sounds_on":
               ...
               break;
            case "back_btn":
               _widget.changeView(MeMenuWidget.const_106);
               break;
            default:

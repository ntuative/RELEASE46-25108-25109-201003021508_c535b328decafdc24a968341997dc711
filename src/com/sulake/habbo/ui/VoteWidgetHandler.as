package com.sulake.habbo.ui
{
   ...
   public class VoteWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionVoteEvent.const_127:
               _loc3_ = new RoomWidgetVoteUpdateEvent(RoomWidgetVoteUpdateEvent.const_127,_loc2_.question,_loc2_.choices);
               break;
            case RoomSessionVoteEvent.const_104:
               _loc3_ = new RoomWidgetVoteUpdateEvent(RoomWidgetVoteUpdateEvent.const_104,_loc2_.question,_loc2_.choices,_loc2_.votes,_loc2_.totalVotes);
         }
         if(_loc3_ == null)
         {
            return;
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(RoomSessionVoteEvent.const_104);
         return _loc1_;
      }

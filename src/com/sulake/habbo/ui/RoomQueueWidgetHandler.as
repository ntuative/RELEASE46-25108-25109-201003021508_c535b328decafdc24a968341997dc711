package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionQueueEvent.const_479:
               ...
               {
                  case RoomSessionQueueEvent.const_916:
                     _loc3_ = "null";
                     break;
               ...
               if(_loc5_.length > 1)
               {
                  if(_loc4_ && _loc2_.queueTypes.indexOf(RoomSessionQueueEvent.const_790) != -1)
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_790) + 1;
                     _loc7_ = true;
                  }
                  else
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_1311) + 1;
                  }
               }
               else
               {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomQueueMessage.const_533);
         _loc1_.push(RoomWidgetRoomQueueMessage.const_706);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               ...
               break;
            case RoomWidgetRoomQueueMessage.const_533:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_916);
               break;
            case RoomWidgetRoomQueueMessage.const_706:
               if(false)
               {
      ...
      {
         return [RoomSessionQueueEvent.const_479];
      }

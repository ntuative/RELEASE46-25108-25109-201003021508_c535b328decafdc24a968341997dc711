package com.sulake.habbo.ui
{
   ...
   public class FurniChooserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_450;
      }
      ...
      private function handleFurniChooserRequest() : void
      {
         ...
         var _loc3_:* = [];
         var _loc9_:int = _container.roomEngine.getRoomObjectCount(_loc1_,_loc2_,RoomObjectCategoryEnum.const_29);
         _loc4_ = 0;
         while(_loc4_ < _loc9_)
         {
            ...
            if(_loc8_ != null)
            {
               _loc5_ = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_315);
         ...
         _container.events.dispatchEvent(new RoomWidgetChooserContentEvent(RoomWidgetChooserContentEvent.const_701,_loc3_,_container.sessionDataManager.isAnyRoomController));
      }

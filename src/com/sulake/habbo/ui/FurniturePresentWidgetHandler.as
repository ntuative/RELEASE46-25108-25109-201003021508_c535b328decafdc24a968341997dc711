package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      private static const const_1116:String = "poster";
      ...
      {
         var _loc3_:RoomWidgetPresentDataUpdateEvent = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_75,0,_name,false,param2);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_648,RoomWidgetPresentOpenMessage.const_667,RoomWidgetPresentOpenedMessage.const_1137];
      }
            ...
            switch(param1.type)
            {
               case RoomSessionPresentEvent.const_242:
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     else if(_loc2_.itemType == ProductTypeEnum.const_73)
                     {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_73:
                           if(_loc3_ != null && _loc3_.name == const_176)
                           {
                           ...
                           else if(_loc3_ != null && _loc3_.name == const_177)
                           {
                           ...
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_476,0,_container.localization.getKey("inventory.furni.item.wallpaper.name"),false,null);
                           }
                           else
                           {
                              if(_loc3_ != null && _loc3_.name == const_1116)
                              {
                                 break;
                              }
                              ...
                              if(_loc4_ != null)
                              {
                                 _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_75,0,_name,false,_loc4_.data);
                              }
                           }
                           break;
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_648:
               ...
               break;
            case RoomWidgetPresentOpenMessage.const_667:

package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_701:Map = null;
      
      private var var_478:Vector3d;
      
      private var _connection:IConnection = null;
      
      private var var_476:Map = null;
      
      public function ChatWidgetHandler()
      {
         var_478 = new Vector3d();
         super();
         var_476 = new Map();
         var_701 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_476.length)
            {
               _loc2_ = var_476.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_476.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_701.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    ...
                                    default:
                                       ...
                                       if(_loc16_ != null)
                                       {
                                          _loc13_ = _loc16_.getCroppedImage(AvatarSetType.const_45).clone();
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_476.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_701.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_563,RoomWidgetChatSelectAvatarMessage.const_702];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_563:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_147,_container.roomSession,0,"Version 25108-25109-201003021429");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_702:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_840 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_840);
            }
            if(var_477 == null)
            {
               var_478.x = 0;
               var_478.y = 0;
               var_478.z = 0;
               var_477 = _loc4_.getScreenPoint(var_478);
               var_840 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_478.x = 0;
            var_478.y = 0;
            var_478.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_478);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_477.x || _loc8_.y != var_477.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_477,_loc5_));

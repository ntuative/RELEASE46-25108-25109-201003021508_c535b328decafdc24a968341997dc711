package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_737:String = "InitConnection";
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_334.shockwaveClientUrl = var_108.shockwaveClientUrl;
         var_334.ssoTicket = var_108.ticket;
         var_108.removeEventListener(SSOTicket.const_278,onParsedTicketSuccess);
         var_108.removeEventListener(SSOTicket.const_267,onParsedTicketFailure);
         var_108 = null;
         dispatchEvent(new Event(const_737));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1398,"/");
      ...
      private function createWindow() : void
      {
         ...
         _window = var_334.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_446,HabboWindowStyle.const_39,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1398,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         var_108 = new SSOTicket(var_334.assets,_loc2_,_loc1_);
         var_108.addEventListener(SSOTicket.const_278,onParsedTicketSuccess);
         var_108.addEventListener(SSOTicket.const_267,onParsedTicketFailure);
      }

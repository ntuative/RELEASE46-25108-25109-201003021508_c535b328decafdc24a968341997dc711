   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private function bannerLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         else if(param1.type == AssetLoaderEvent.const_31)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_420));
            }
      ...
      {
         var _loc3_:AssetLoaderStruct = var_679.loadAssetFromFile("hotel_view_banner_" + var_804,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_626));
            }
            var_180 = param2;

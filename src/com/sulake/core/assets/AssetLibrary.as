package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_939:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_535:uint = 0;
      
      public static const const_912:String = "AssetLibraryReady";
      
      public static const const_1317:String = "AssetLibraryUnloaded";
      
      public static const const_363:String = "AssetLibraryLoaded";
      
      public static const const_1365:String = "AssetLibraryLoadError";
       
      
      private var var_442:XML;
      
      private var var_370:Dictionary;
      
      private var var_323:Array;
      
      private var var_183:uint;
      ...
      private var var_441:Boolean = true;
      
      private var var_322:Class;
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_370)
         {
            _loc4_ = AssetTypeDeclaration(var_370[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_369)
         {
            _loc2_ = var_369[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_369[_loc1_];
         }
         for(_loc1_ in _loadedAssets)
         {
            delete _loadedAssets[_loc1_];
         }
         for(_loc1_ in var_625)
         {
            delete var_625[_loc1_];
         }
         if(var_14 != null)
         {
            var_14.dispose();
         ...
         var_287 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1317));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_442 = _loc2_.manifest.copy();
         var_322 = _loc2_.resource;
         if(var_441)
         {
            AssetLibrary.fetchLibraryContents(this,var_442,var_322);
         }
         var_287 = true;
         dispatchEvent(new Event(AssetLibrary.const_363));
         dispatchEvent(new Event(AssetLibrary.const_912));
         if(var_441)
         {
            var_14.dispose();
            var_14 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_369[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_42,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_823,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_873,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_820,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_948,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_369[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_370.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_370[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_939.splice(var_939.indexOf(this),1);
            --var_535;
            var_369 = null;
            var_625 = null;
            _loadedAssets = null;
      ...
      {
         return param1 < var_323.length ? getAssetByName(var_323[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1365));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_370)
         {
            _loc3_ = AssetTypeDeclaration(var_370[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_625[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_14 == null)
            {
               var_14 = new LibraryLoader(_debug);
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_442.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_322[param1]);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_369[loader.url];
         if(struct == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_323.splice(var_323.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_370[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_322 != null ? false : false;
      }
   }
}

package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1577:uint = 1;
      
      public static const COMPONENT_EVENT_DEBUG:String = "COMPONENT_EVENT_DEBUG";
      
      public static const const_934:uint = 4;
      ...
      protected var var_2175:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_920 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_920);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1101 & const_934)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_423 + "]";
      }
   }
}

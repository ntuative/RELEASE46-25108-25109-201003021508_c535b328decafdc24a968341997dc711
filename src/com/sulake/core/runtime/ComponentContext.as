   ...
   public class ComponentContext extends Component implements IContext
   {
      ...
      protected final function announceInterfaceAvailability(param1:IID, param2:Component) : void
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            if(_loc4_ == null)
            {
               error("Interface " + param1 + " still unavailabe!",true,Core.const_1232);
            }
      ...
      override public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc11_:int = 0;
         while(_loc11_ < var_285.length)
         {
            _loc10_ = var_285[_loc11_] as Component;
            if(_loc10_ != this)
            {
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            if(var_364 != null)
            {
               ...
               while(_loc1_-- > 0)
               {
                  IDisposable(var_364.pop()).dispose();
               }
               var_364 = null;
            }
            if(var_242 != null)
      ...
      protected final function hasQueueForInterface(param1:IID) : Boolean
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if(getQualifiedClassName(var_364[_loc4_].identifier) == _loc2_)
            {
               return true;
            }
            _loc4_++;
      ...
      protected function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         removeLibraryLoader(_loc2_);
         error("Failed to download component resource \"" + _loc2_.url + "\"!" + "\r" + _loc3_,true,Core.const_1334);
      }
      ...
      public final function detachComponent(param1:Component) : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < var_285.length)
         {
            if(var_285[_loc4_] == param1)
            {
               var_285.splice(_loc4_,1);
               return;
            }
            _loc4_++;
         }
         ...
         while(i < componentList.length())
         {
            ...
            if(assetCount > 0)
            {
               ...
               while(k < assetCount)
               {
                  ...
                  {
                     error("Manifest for component " + componentString + " contains broken asset \"" + assetName + "\"!",true,Core.const_618);
                  }
                  k++;
               }
            }
            ...
            if(componentClass == null)
            {
               error("Invalid component class " + componentString + "!",true,Core.const_618);
               return false;
            }
            ...
            if(component != null)
            {
               if(assetLibrary != null)
               {
                  if(component.assets != assetLibrary)
                  {
                     ...
                     error("Component \"" + componentString + "\" did not save provided asset library!",true,Core.const_618);
                  }
               }

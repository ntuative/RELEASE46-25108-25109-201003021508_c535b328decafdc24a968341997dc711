package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1549:String = "_INCLUDE";
      
      public static const ELEMENT_TAG_EXCLUDE:String = "_EXCLUDE";
      
      public static const const_1488:String = "_TEMP";
      
      private static const const_1106:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1105:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1100:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_930:Dictionary;
      
      protected var var_1364:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1365:Dictionary;
      
      protected var var_1099:Dictionary;
      
      public function WindowParser(param1:IWindowContext)
      {
         super();
         _context = param1;
         var_1099 = new Dictionary();
         var_1100 = new Dictionary();
         TypeCodeTable.fillTables(var_1099,var_1100);
         var_930 = new Dictionary();
         var_1365 = new Dictionary();
         ParamCodeTable.fillTables(var_930,var_1365);
         var_1364 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1105,"");
         return param1.replace(const_1106,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1099)
            {
               delete var_1099[_loc1_];
            }
            for(_loc1_ in var_1100)
            {
               delete var_1100[_loc1_];
            }
            for(_loc1_ in var_930)
            {
               delete var_930[_loc1_];
            }
            for(_loc1_ in var_1365)
            {
               delete var_1365[_loc1_];
            }
            var_1364.dispose();
            var_1364 = null;
            _context = null;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         background = parseAttribute(xml,"background",variables,background.toString()) == "HabboNavigatorCom_rico_ob5_png";
         treshold = uint(parseAttribute(xml,"treshold",variables,treshold.toString()));
         visible = parseAttribute(xml,"visible",variables,visible.toString()) == "HabboNavigatorCom_rico_ob5_png";
         clipping = parseAttribute(xml,"clipping",variables,clipping.toString()) == "HabboNavigatorCom_rico_ob5_png";

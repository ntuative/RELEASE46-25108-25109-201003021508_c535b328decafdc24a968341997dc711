package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_317:Dictionary;
      
      protected var var_316:Dictionary;
      
      protected var var_434:Dictionary;
      
      public function SkinRenderer(param1:Array)
      {
         super();
         var_317 = new Dictionary();
         var_316 = new Dictionary();
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            for(_loc2_ in var_316)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(var_316[_loc3_] == param1)
               {
                  removeTemplateFromRenderState(_loc3_);
               }
            }
            delete var_317[param1.name];
         }
         return param1;
      }
      ...
      {
         var _loc3_:ISkinLayout = var_434[param2];
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:ISkinTemplate = var_317[param2];
         if(_loc3_ == null)
         {
            throw new Error("Template \"" + param2 + "\" not found in renderer!");
         }
         var_316[param1] = _loc3_;
      }
      
      public function getTemplateByState(param1:uint) : ISkinTemplate
      {
         return var_316[param1];
      }
      
      public function dispose() : void
      {
         var _loc1_:* = null;
         for(_loc1_ in var_434)
         {
            ISkinLayout(var_434[_loc1_]).dispose();
            delete var_434[_loc1_];
         }
         var_434 = null;
         _layoutsByState = null;
         for(_loc1_ in var_317)
         {
            ISkinTemplate(var_317[_loc1_]).dispose();
            delete var_317[_loc1_];
         }
         var_317 = null;
         var_316 = null;
      }

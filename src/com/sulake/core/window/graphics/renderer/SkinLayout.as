package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinLayout extends ChildEntityArray implements ISkinLayout
   {
      ...
      protected var var_928:IChildEntityArray;
      ...
      public function getDefaultRegion(param1:String, param2:Rectangle) : void
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = var_928.getChildByName(param1) as ISkinLayoutEntity;
            if(_loc3_ == null)
            {
      ...
      public function isFixedHeight() : Boolean
      {
         ...
         while(_loc2_ < _loc1_)
         {
            if(ISkinLayoutEntity(getChildAt(_loc2_)).scaleV != SkinLayoutEntity.const_431)
            {
               return false;
            }
            _loc2_++;
      ...
      public function dispose() : void
      {
         ...
         for(_loc3_ in var_928)
         {
            ISkinLayoutEntity(var_928[_loc3_]).dispose();
            delete var_928[_loc3_];
         }
      }
      ...
      public function isFixedWidth() : Boolean
      {
         ...
         while(_loc2_ < _loc1_)
         {
            if(ISkinLayoutEntity(getChildAt(_loc2_)).scaleH != SkinLayoutEntity.const_431)
            {
               return false;
            }
            _loc2_++;

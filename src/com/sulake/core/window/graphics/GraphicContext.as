package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_871:uint = 256;
      
      protected static var var_620:uint = 0;
      
      protected static var var_367:uint = 0;
      
      public static const const_815:uint = 2;
      
      public static const const_1518:uint = 128;
      
      public static const const_1505:uint = 64;
      
      public static const const_661:uint = 4;
      
      public static const const_1367:uint = 0;
      
      public static const const_1326:uint = 16;
      
      public static const const_620:uint = 1;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_815:
               ...
               break;
            case GraphicContext.const_1159:
               setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1326:
               setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_661:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_871:
               break;
            case GraphicContext.const_1367:
               break;
            default:
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(var_617)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_367 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
         ...
         if(var_617)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_367 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }

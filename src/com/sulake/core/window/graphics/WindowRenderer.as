package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_296:Dictionary;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_572 = new Array();
         var_1478 = new Point();
         var_1479 = new Rectangle();
         var_297 = new Rectangle();
         var_296 = new Dictionary(true);
         var_722 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_296[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = var_572.pop() as WindowController;
            if(!_loc1_.disposed)
            {
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_579,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_296[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            _disposed = true;
            var_572 = null;
            for(_loc1_ in var_296)
            {
               delete var_296[_loc1_];
            }
            var_296 = null;
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1478,var_1479))
            {
               if(param2.render(param1,var_1478,var_1479))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,_drawBufferAllocator,var_722);
            var_296[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_579,windowDisposedCallback);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            getWindowRendererItem(param1).invalidate(param1,var_297,WindowRedrawFlag.const_262);

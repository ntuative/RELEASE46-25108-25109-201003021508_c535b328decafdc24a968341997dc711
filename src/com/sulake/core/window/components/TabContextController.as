package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_1585:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1585 == null)
         {
            var_1585 = findChildByTag(TabContextController.const_1063) as IWindowContainer;
         }
         return var_1585;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_924 == null)
         {
            var_924 = findChildByTag(TabContextController.const_1064) as ITabSelectorWindow;
            if(var_924 != null)
            {
               var_924.procedure = selectorEventProc;
            }
         }
         return var_924;
      }
      ...
      {
         return !!var_856 ? selector.iterator : null;
      }

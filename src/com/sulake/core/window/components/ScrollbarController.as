package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1115:String = "increment";
      
      private static const const_494:String = "slider_bar";
      
      private static const const_1114:String = "decrement";
      
      private static const const_784:String = "slider_track";
      ...
      protected var var_745:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_161 = false;
         var_21 = param12;
         _horizontal = param2 == WindowType.const_364;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_494:
         ...
         if(param2.type == WindowNotifyEvent.const_459)
         {
            if(var_21 == null)
            {
               resolveScrollTarget();
      ...
      {
         return findChildByName(ScrollbarController.const_784) as WindowController;
      }
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(var_21 != null && true)
         {
            IWindow(var_21).removeEventListener(WindowEvent.const_43,onScrollableResized);
         }
         var_21 = param1;
         if(var_21 != null && true)
         {
            IWindow(var_21).addEventListener(WindowEvent.const_43,onScrollableResized);
            updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return track.findChildByName(ScrollbarController.const_494) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_893 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_893 != null)
         {
            _loc1_ = findParentByName(var_893) as IScrollableWindow;
            if(_loc1_ == null && var_6 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_6).findChildByName(var_893) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1115)
            {
               if(var_21)
               {
                  var_606 = true;
            ...
            else if(param2.name == ScrollbarController.const_1114)
            {
               if(var_21)
               {
                  var_606 = true;
            ...
            else if(param2.name == ScrollbarController.const_784)
            {
               _loc4_ = new Point();
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_494).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_888)
         {
      ...
      private function updateLiftSizeAndPosition() : void
      {
         ...
         if(_loc3_ != null)
         {
            if(_horizontal)
            {
               _loc1_ = Number(var_21.visibleRegion.width / var_21.method_1.width);
               if(_loc1_ > 1)
               {
                  _loc1_ = 1;
               }
            ...
            {
               _loc1_ = Number(var_21.visibleRegion.height / var_21.method_1.height);
               if(_loc1_ > 1)
               {
                  _loc1_ = 1;
               }

package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_208:Boolean;
      
      protected var var_68:TextMargins;
      
      protected var var_526:String = "none";
      
      protected var var_616:Number;
      
      protected var var_363:Number;
      
      protected var _field:TextField;
      
      protected var var_744:Boolean = false;
      ...
      {
         var_68 = new TextMargins(0,0,0,0,setTextMargins);
         var_208 = false;
         var_616 = 0;
         var_363 = 0;
         if(_field == null)
      ...
      {
         param1.var_68.dispose();
         param1.var_68 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         param1.refreshTextImage();
      }
      ...
      {
         return new Rectangle(var_616 * maxScrollH,var_363 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_744)
         {
            context.removeLocalizationListener(var_319,this);
         }
         if(var_68 != null)
         {
            var_68.dispose();
      ...
      {
         var_616 = param1;
         _field.scrollH = var_616 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_319 = param1;
         if(var_319.charAt(0) == "$" && var_319.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_319.slice(2,var_319.indexOf("}")),this);
            var_744 = true;
         }
         else if(_field != null)
         {
      ...
      public function setTextMargins(param1:IMargins) : void
      {
         ...
         {
            var_68.dispose();
            var_68 = new TextMargins(param1.left,param1.top,param1.right,param1.bottom,setTextMargins);
         }
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_827,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_430,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.STRING,true));
         _loc1_.push(new PropertyStruct("always_show_selection",_field.alwaysShowSelection,PropertyStruct.const_56,true));
         _loc1_.push(new PropertyStruct("border",_field.border,PropertyStruct.const_56,false));
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_430,true));
         _loc1_.push(new PropertyStruct("condense_white",_field.condenseWhite,PropertyStruct.const_56,true));
         _loc1_.push(new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_56,true));
         _loc1_.push(new PropertyStruct("embed_fonts",_field.embedFonts,PropertyStruct.const_56,true));
         _loc1_.push(new PropertyStruct("grid_fit_type",_field.gridFitType,PropertyStruct.STRING,true));
         _loc1_.push(new PropertyStruct("max_chars",_field.maxChars,PropertyStruct.const_63,true));
         _loc1_.push(new PropertyStruct("mouse_wheel_enabled",_field.mouseWheelEnabled,PropertyStruct.const_56,true));
         _loc1_.push(new PropertyStruct("multiline",_field.multiline,PropertyStruct.const_56,true));
         _loc1_.push(new PropertyStruct("restrict",_field.restrict,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_718,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_718,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_56,true));
         _loc1_.push(new PropertyStruct("margin_left",var_68.left,PropertyStruct.const_63,true));
         _loc1_.push(new PropertyStruct("margin_top",var_68.top,PropertyStruct.const_63,true));
         _loc1_.push(new PropertyStruct("margin_right",var_68.right,PropertyStruct.const_63,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_68.bottom,PropertyStruct.const_63,true));
         _loc1_.push(new PropertyStruct("auto_size",var_526,PropertyStruct.STRING,var_526 != TextFieldAutoSize.NONE));
         _loc1_.push(new PropertyStruct("bold",_field.defaultTextFormat.bold != false,PropertyStruct.const_56,_field.defaultTextFormat.bold != false));
         _loc1_.push(new PropertyStruct("italic",_field.defaultTextFormat.italic != false,PropertyStruct.const_56,_field.defaultTextFormat.italic != false));
         _loc1_.push(new PropertyStruct("underline",_field.defaultTextFormat.underline != false,PropertyStruct.const_56,_field.defaultTextFormat.underline != false));
         _loc1_.push(new PropertyStruct("kerning",_field.defaultTextFormat.kerning != false,PropertyStruct.const_56,_field.defaultTextFormat.kerning != false));
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_718,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_616 = var_616;
         _loc1_.var_363 = var_363;
         _loc1_.var_68 = var_68.clone(_loc1_.setTextMargins);
         _loc1_.var_526 = var_526;
         _loc1_.var_744 = var_744;
         return _loc1_;
      }

package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_850:IItemListWindow;
      
      private var var_342:IScrollbarWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_342)
         {
            var_342 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_342)
            {
               var_342.addEventListener(WindowEvent.const_232,scrollBarEventProc);
               var_342.addEventListener(WindowEvent.const_195,scrollBarEventProc);
            }
         }
         return var_342;
      }
      ...
      override public function dispose() : void
      {
         if(var_342)
         {
            var_342.removeEventListener(WindowEvent.const_232,scrollBarEventProc);
            var_342.removeEventListener(WindowEvent.const_195,scrollBarEventProc);
            var_342 = null;
         }
         if(var_850)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_195)
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_850)
         {
            var_850 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_850;
      }

package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1110:String = "_HEADER";
      
      private static const const_777:String = "margin_right";
      
      private static const const_1111:String = "_SCALER";
      
      private static const const_1067:String = "_TITLE";
      
      private static const const_1109:String = "_CONTENT";
      ...
      private var var_1293:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_779,_loc3_.left,PropertyStruct.const_63,_loc2_));
         _loc1_.push(new PropertyStruct(const_778,_loc3_.top,PropertyStruct.const_63,_loc2_));
         _loc1_.push(new PropertyStruct(const_777,0 - _loc3_.right,PropertyStruct.const_63,_loc2_));
         _loc1_.push(new PropertyStruct(const_780,0 - _loc3_.bottom,PropertyStruct.const_63,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_231);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_190);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_205);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_190,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_190,false);
            }
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_205,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_205,false);
            }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1293 == null)
         {
            var_1293 = findChildByTag(const_1110) as IHeaderWindow;
            if(!var_1293)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1067) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1111) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_252,false);
         }
      ...
      {
         return content != null && var_1360 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_20 == null)
         {
            var_20 = findChildByTag(const_1109) as IWindowContainer;
            if(!var_20)
            {

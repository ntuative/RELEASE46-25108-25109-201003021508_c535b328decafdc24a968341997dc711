package com.sulake.core.window.components
{
   ...
   public class ScrollbarLiftController extends InteractiveController implements IDragBarWindow
   {
      ...
      {
         if(param2.type == WindowNotifyEvent.const_429)
         {
            _offsetX = x != 0 ? Number(x / Number(0 - width)) : Number(0);
            var_782 = y != 0 ? Number(y / Number(0 - height)) : Number(0);
            if(var_6 != _scrollBar)
            {
               _scrollBar.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_241,this,null));
            }
         }

package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         {
            var_138 = context.create(name + "::submenu","",WindowType.const_403,var_81,0 | 0,_loc1_,subMenuEventProc,null,0,null,[WindowController.EXCLUDE_CHILD_TAG]) as DropMenuController;
         }
         else
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowEvent.const_864)
         {
            if(param2 == var_138)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_415,var_81,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_281,var_81,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         if(var_511 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_511).setStateFlag(WindowState.const_46,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_605)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_512,getSubMenu(),subMenuEventProc);
                  var_605 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_396,this,null,true);
         update(this,_loc2_);
         if(!_loc2_.isWindowOperationPrevented())
         {
            var_511 = param1;
            closeMenuView();
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_330,this,null));
         }
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_605 = false;
            getTitleText().text = var_511 < var_512.length && var_511 > -1 ? "null" : caption;
         }
      }
   }
}

package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private var var_307:Rectangle;
      
      protected var var_615:Function;
      
      protected var _children:Array;
      
      protected var _debug:Boolean = false;
      
      private var var_2125:uint;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(!var_16)
         {
            var_16 = getGraphicContext(!testParamFlag(WindowParam.const_30));
         }
         _events = new EventDispatcher(this);
         _children = new Array();
         var_307 = new Rectangle();
         if(_loc12_ != null)
         {
            var_362 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_54 = var_362.clone();
            var_5 = var_362.clone();
         ...
         if(_loc9_)
         {
            ...
            if(param2)
            {
               ...
               while(_loc3_ < _loc10_)
               {
                  ...
                  _loc13_ = param1.testParamFlag(WindowParam.const_79);
                  if(_loc13_)
                  {
                     param1.setParamFlag(WindowParam.const_79,false);
                  }
                  param1.offset(-_loc4_,-_loc5_);
                  if(_loc13_)
                  {
                     param1.setParamFlag(WindowParam.const_79,true);
                  }
                  _loc3_++;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_123,WindowParam.const_135);
         var _loc2_:* = !testParamFlag(WindowParam.const_114,WindowParam.const_138);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_5.clone();
            if(_loc1_)
            {
               ...
               {
                  if(var_6.width < _loc3_.width && getParamFlag(WindowParam.const_30))
                  {
                     _loc3_.x = 0;
                  }
                  else
            ...
            if(_loc2_)
            {
               _loc4_ = 0 - 0;
               _loc5_ = uint(var_15 & 0);
               if(_loc5_ == WindowParam.const_258)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_327)
               {
                  _loc3_.y += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_165)
               {
                  if(var_6.height < _loc3_.height && getParamFlag(WindowParam.const_30))
                  {
                     _loc3_.y = 0;
                  }
                  else
         ...
         else if(testParamFlag(WindowParam.const_79))
         {
            _loc3_ = var_5.clone();
            if(var_6 != null)
            {
      ...
      {
         var_742 = param1;
         var_614 = !!var_742 ? uint(var_614 | var_1363) : uint(var_614 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2125 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_513:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_607:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_1007:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_653:
               _loc2_ = "null";
               break;
      ...
      public function restore() : Boolean
      {
         ...
         setStateFlag(WindowState.const_61,false);
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_16)
         {
            var_16 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_620,var_5);
      ...
      public function minimize() : Boolean
      {
         ...
         setStateFlag(WindowState.const_61,true);
      ...
      {
         var_410 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_289,this,param1));
         return param1;
      }
      ...
      {
         return !testParamFlag(WindowParam.const_30) || var_16 != null;
      }
      ...
      {
         var_1363 = param1 & 4278190080;
         var_614 = !!var_742 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_5,WindowRedrawFlag.const_71);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_678))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_802;
                  if(testParamFlag(WindowParam.const_334))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_222))
                        {
                  ...
                  if((var_15 & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_231))
                        {
                           _context.getWindowServices().getMouseScalingService().begin(_loc5_,var_15 & 0);
                           break;
                        }
                        _loc5_ = _loc5_.parent;
                     }
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_222))
                  {
                     _context.getWindowServices().getMouseDraggingService().end(this);
                  }
                  if(testParamFlag(WindowParam.const_231))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_198:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_445,this,null));
                     if(testParamFlag(WindowParam.const_170,WindowParam.const_135))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_165,WindowParam.const_138))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_6 != null)
                     {
                        _loc8_ = uint(var_15);
                        var_15 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_418))
                        {
                           var_6.width += 0 - 0;
                        }
                        ...
                        var_15 = _loc8_;
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_272,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_429:
                  _context.invalidate(this,var_5.union(var_54),WindowRedrawFlag.const_386);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_997,this,null));
                     if(var_6 != null)
                     {
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_241,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_309:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_589,this,null));
                     if(var_6 != null)
                     {
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_213,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_382:
                  _context.invalidate(this,var_5,WindowRedrawFlag.const_845);
                  break;
               case WindowNotifyEvent.const_455:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_428:
                  if(!(var_15 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_5,WindowRedrawFlag.const_386);
                     }
                  }
                  else if(var_15 & 0)
                  {
               ...
               case WindowNotifyEvent.const_213:
                  ...
                  break;
               case WindowNotifyEvent.const_445:
                  var_6.getRegionProperties(null,var_307);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_289:
      ...
      {
         return var_615 != null ? var_615 : (var_6 != null ? var_6.procedure : nullEventProc);
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_309;
         update(this,_loc1_);
         return true;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_672,this,param1));
         return param1;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_653;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         return !testParamFlag(WindowParam.const_30) ? getGraphicContext(true).fetchDrawBuffer() : (var_6 != null ? var_6.fetchDrawBuffer() : null);
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            _loc7_ = uint(var_15 & 0);
            if(_loc7_ == WindowParam.const_482)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_426)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(var_15 & 0);
            if(_loc7_ == WindowParam.const_384)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_406)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         }
         if(testParamFlag(WindowParam.const_79))
         {
            if(var_6 != null)
            {
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_906,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_634,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_198,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1351,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         if(var_161 && var_743 > 0)
         {
            if(!testParamFlag(WindowParam.const_30))
            {
               if(param1.x <= var_5.width && param1.y <= var_5.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1553,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1553,param3,param1)) : false;
            }
         }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1331,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_6 != param1)
         {
            ...
            if(var_6 != null)
            {
               var_307 = var_6.rectangle.clone();
               var_54.x = var_5.x;
               var_54.y = var_5.y;
               var_54.width = var_5.width;
               var_54.height = var_5.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_459,this,var_6));
            }
            else
            {
               var_307.x = 0;
               ...
               var_307.width = 0;
               var_307.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1003,this,_loc2_));
            }
         }
      }
      ...
      {
         var _loc3_:uint = var_15;
         var _loc4_:*;
         var_15 = !!param2 ? (_loc4_ = var_15 | param1, var_15 |= param1, uint(_loc4_)) : (_loc4_ = var_15 & ~param1, var_15 &= ~param1, uint(_loc4_));
         if(var_15 != _loc3_)
         {
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_81,var_15,_context,var_5,null,var_615,properties,var_613.concat(),_id) as WindowController;
         _loc2_.var_743 = var_743;
         _loc2_.var_161 = var_161;
         _loc2_._debug = _debug;
         _loc2_.var_307 = var_307.clone();
         _loc2_.var_5 = var_5.clone();
         _loc2_.var_362 = var_362.clone();
         ...
         _loc2_.var_614 = var_614;
         _loc2_.var_1363 = var_1363;
         _loc2_.var_1098 = var_1098;
         _loc2_.var_335 = var_335;
         _loc2_.var_410 = var_410;
         _loc2_.var_15 = var_15;
         _loc2_.var_32 = var_32;
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_319;
         _loc2_.background = var_742;
      ...
      {
         var _loc3_:uint = var_32;
         var _loc4_:*;
         var_32 = !!param2 ? (_loc4_ = var_32 | param1, var_32 |= param1, uint(_loc4_)) : (_loc4_ = var_32 & ~param1, var_32 &= ~param1, uint(_loc4_));
         if(var_32 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_382,this,null));
         }
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_623;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_473;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_797,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_807;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         if(var_32 == WindowState.const_469)
         {
            return true;
         }
